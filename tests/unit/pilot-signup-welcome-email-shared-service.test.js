...
/**
 * Unit tests for feat-transactional-email-resend (pilot-signup consolidation)
 *
 ...
 *  3. Calls sendWelcomeEmail with (agentEmail, agentId, { planTier, dashboardUrl, agentName })
 *  4. The shared email-service.ts exports sendWelcomeEmail
 */
...
function run() {
  ...
  check('pilot-signup does NOT contain inline sendWelcomeEmail function body', () => {
    // The inline version had a raw fetch to resend.com and a 60-day pilot HTML template
    const hasInlineImpl =
