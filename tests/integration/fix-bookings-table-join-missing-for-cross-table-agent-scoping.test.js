...
async function testCommentsAndDocumentation() {
  ...
  const hasComment = routeContent.includes('bookings.agent_id may be NULL') || 
    routeContent.includes('join through leads') ||
    routeContent.includes('cross-table');
