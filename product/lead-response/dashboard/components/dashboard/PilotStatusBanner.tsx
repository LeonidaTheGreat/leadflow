      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            >
              {isEndingSoon ? '⚠️ Pilot ending soon' : '🎉 You\'re on a free pilot'}
            </h3>
            <span
          ...
          >
            {isEndingSoon
              ? `Your pilot ends in ${daysRemaining} day${daysRemaining !== 1 ? 's' : ''}. Upgrade to keep your AI lead response running.`
              : 'Enjoy 60 days of free AI lead response. Upgrade any time to lock in your pricing.'}
          </p>

          {/* Always show upgrade CTA for pilot agents */}
          <div className="mt-3 flex flex-col sm:flex-row gap-2 items-start sm:items-center">
            <UpgradeButton
              plan="pro"
              label={isEndingSoon ? 'Upgrade Now — from $49/mo' : 'Upgrade to Paid — from $49/mo'}
              variant={isEndingSoon ? 'primary' : 'outline'}
              size="sm"
            />
            <a
