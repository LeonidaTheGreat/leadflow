...
process.env.STRIPE_PRICE_STARTER_MONTHLY = 'price_1AbCdEfGhIjKlMnO'
process.env.STRIPE_PRICE_PRO_MONTHLY = 'price_1PqRsTuVwXyZaBcD'
process.env.STRIPE_PRICE_TEAM_MONTHLY = 'price_1EfGhIjKlMnOpQrS'
