      ...
      <section className="bg-teal-600 py-12 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-sm font-semibold text-teal-100 uppercase tracking-wide">Response Time</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="text-4xl sm:text-5xl font-bold text-white">78%</div>
            <div className="text-sm font-semibold text-teal-100 uppercase tracking-wide">Deals to First Responder</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="text-4xl sm:text-5xl font-bold text-white">35%</div>
            <div className="text-sm font-semibold text-teal-100 uppercase tracking-wide">Leads Never Responded To</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="text-4xl sm:text-5xl font-bold text-white">24/7</div>
            <div className="text-sm font-semibold text-teal-100 uppercase tracking-wide">Always On</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center p-6"><div className="text-4xl sm:text-5xl font-bold text-teal-600 mb-2">&lt;30s</div><div className="text-sm text-gray-600 font-medium">Response Time</div></div>
            <div className="text-center p-6"><div className="text-4xl sm:text-5xl font-bold text-teal-600 mb-2">78%</div><div className="text-sm text-gray-600 font-medium">Deals to First Responder</div></div>
            <div className="text-center p-6"><div className="text-4xl sm:text-5xl font-bold text-teal-600 mb-2">35%</div><div className="text-sm text-gray-600 font-medium">Leads Never Responded To</div></div>
            <div className="text-center p-6"><div className="text-4xl sm:text-5xl font-bold text-teal-600 mb-2">24/7</div><div className="text-sm text-gray-600 font-medium">Always On</div></div>
          </div>
