  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="mt-20 max-w-xl mx-auto text-center bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-8">
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">
            Free Guide: 5 Ways AI Closes More Leads
          </h3>
          <p className="text-slate-600 dark:text-slate-400 mb-6">
            Get our playbook for converting more real estate leads with AI — zero spam, unsubscribe anytime.
          </p>
          <Link
            href="/guide"
            onClick={() => trackCTAClick('lead_magnet_cta', 'Download Free Guide', 'lead_magnet')}
