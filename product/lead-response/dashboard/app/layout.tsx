...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered lead response for real estate agents. Respond in under 30 seconds with AI. Integrate with Follow Up Boss, book appointments automatically, and never miss another opportunity.",
};
