              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-12 w-full pl-10 bg-slate-900 border-slate-600 text-white placeholder:text-slate-500"
                    required
                    disabled={loading}
                    autoComplete="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="••••••••"
                    className="h-12 w-full pl-10 pr-10 bg-slate-900 border-slate-600 text-white placeholder:text-slate-500"
                    required
                    disabled={loading}
