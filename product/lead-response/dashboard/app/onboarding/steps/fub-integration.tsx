...
import { Key, AlertCircle, CheckCircle2, ExternalLink, Shield } from 'lucide-react'

export default function FUBIntegrationStep({
  onNext,
  onBack,
  agentData,
  setAgentData,
  ...
  const [apiKey, setApiKey] = useState(agentData.fubApiKey || '')
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700/50 rounded-2xl p-8 md:p-12">
        ...
        <div className="p-4 bg-slate-700/20 rounded-lg mb-8">
          <p className="text-slate-300 text-sm">
            ⚠️ <strong>Optional:</strong> You can skip this for now and connect FUB later in your settings.
          </p>
        </div>
