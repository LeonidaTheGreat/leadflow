...
-- FIXED VERSION - All INSERT statements include project_id
...
CREATE INDEX IF NOT EXISTS idx_system_components_project_id ON system_components(project_id);
CREATE INDEX IF NOT EXISTS idx_agents_project_id ON agents(project_id);
CREATE INDEX IF NOT EXISTS idx_completed_work_project_id ON completed_work(project_id);
...
CREATE INDEX IF NOT EXISTS idx_dashboard_snapshots_time ON dashboard_snapshots(snapshot_time DESC);
