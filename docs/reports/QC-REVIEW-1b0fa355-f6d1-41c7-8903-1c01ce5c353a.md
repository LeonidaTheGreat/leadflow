...
- `~/projects/genome/tests/` (source of truth - 98 tests)
...
- [x] All imports resolve correctly (absolute paths to `~/projects/genome/`)
...
### Genome Core Tests (run from `~/projects/genome`)
```
