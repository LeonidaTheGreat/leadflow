...
-- Tracks email sends for pilot conversion sequence at day 30, 45, 55, 75, 79, 85
...
CREATE TABLE IF NOT EXISTS pilot_conversion_email_logs (
    ...
    milestone VARCHAR(20) NOT NULL CHECK (milestone IN ('day_30', 'day_45', 'day_55', 'day_75', 'day_79', 'day_85')),
...
COMMENT ON COLUMN pilot_conversion_email_logs.milestone IS 'Conversion sequence milestone: day_30, day_45, day_55, day_75, day_79, or day_85';
