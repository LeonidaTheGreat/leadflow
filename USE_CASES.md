...
> Generated: 2026-03-17T18:24:45.367Z | Source: `use_cases` + `prds` tables
...
| fix-no-active-session-logging-due-to-lack-of-end-to-en | No active session logging due to lack of end-to-end testing | - | needs_merge | 2 | - | Dev > QC |
...
| fix-dashboard-leadsatisfactioncard-uses-hardcoded-test | Dashboard LeadSatisfactionCard uses hardcoded test-agent-id | - | in_progress | 2 | - | Dev > QC |
