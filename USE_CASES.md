...
> Generated: 2026-03-17T19:32:42.465Z | Source: `use_cases` + `prds` tables

**Progress: 189/196 complete**
...
| fix-inbound-sms-handler-does-not-classify-satisfaction | Inbound SMS handler does not classify satisfaction replies | - | needs_merge | 2 | - | Dev > QC |
| fix-api-route-queries-wrong-table-for-satisfaction-pin | API route queries wrong table for satisfaction_ping_enabled | - | needs_merge | 2 | - | Dev > QC |
...
| fix-sendsatisfactionping-never-called-from-sms-handlin | sendSatisfactionPing never called from SMS handling flow | - | needs_merge | 2 | - | Dev > QC |
