...
> Generated: 2026-03-11T07:55:06.368Z | Source: `use_cases` + `prds` tables

**Progress: 116/129 complete**
...
| fix-how-it-works-section-not-implemented | How It Works section not implemented | - | in_progress | 2 | - | Dev > QC |
...
| fix-analytics-events-table-missing-trial-funnel-tracki | analytics_events table missing — trial funnel tracking fails silently | - | in_progress | 2 | - | Dev > QC |
