...
> Generated: 2026-03-13T18:09:29.609Z | Source: `use_cases` + `prds` tables

**Progress: 149/153 complete**
...
| feat-post-signup-redirect-to-dashboard-onboarding | Post-Signup Redirect to /dashboard/onboarding | - | in_progress | 1 | defined | Dev > QC |
...
| fix-signup-routes-redirect-to-setup-not-dashboard-onbo | Signup routes redirect to /setup not /dashboard/onboarding | - | not_started | 2 | - | Dev > QC |
...
- **PRD:** Post-Signup Redirect to /dashboard/onboarding
- **Status:** complete
- **Priority:** 0
