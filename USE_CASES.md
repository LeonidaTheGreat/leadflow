...
> Generated: 2026-03-08T06:46:59.902Z | Source: `use_cases` + `prds` tables

**Progress: 44/60 complete**
...
| fix-primary-signup-api-api-agents-onboard-does-not-cap | Primary signup API (/api/agents/onboard) does not capture or write UTM parameters | - | not_started | 1 | - | Dev > QC |
...
| fix-signup-plan-options-not-displayed | Signup page shows Choose Your Plan but no plan options are listed | - | not_started | 1 | defined | Dev > QC |
| fix-status | status | - | complete | 1 | - | Dev > QC |
| feat-session-analytics-pilot | Session Analytics — Pilot Agent Usage Tracking | - | not_started | 2 | - | PM > Marketing > Design > Dev > QC |
| improve-landing-page-analytics-ga4 | Landing Page Analytics — GA4/PostHog for CTA Clicks, Scroll Depth & Conversion Funnel | - | not_started | 2 | - | PM > Dev > QC |
...
| feat-nps-agent-feedback | NPS & Feedback Survey for Agents | - | not_started | 2 | - | PM > Marketing > Design > Dev > QC |
...
| improve-landing-page-pricing-4-tiers | Landing Page Pricing Section — All 4 Tiers with Feature Comparison | - | not_started | 2 | - | PM > Design > Dev > QC |
| feat-add-route-discovery-smoke-test | Route Discovery Smoke Test | Phase 3 | complete | 2 | - | PM > Dev > QC |
| fix-landing-page-does-not-capture-utm-params-to-sessio | Landing page does not capture UTM params to sessionStorage | - | not_started | 2 | - | Dev > QC |
...
| feat-sms-analytics-dashboard | SMS Analytics Dashboard — Delivery, Reply & Booking Conversion | - | not_started | 2 | defined | PM > Marketing > Design > Dev > QC |
| fix-onboarding-page-does-not-read-utm-params-from-sess | Onboarding page does not read UTM params from sessionStorage or URL | - | not_started | 2 | - | Dev > QC |
...
| feat-lead-magnet-email-capture | Lead Magnet / Email Capture on Landing Page | - | not_started | 2 | - | PM > Marketing > Design > Dev > QC |
...
| feat-lead-experience-simulator | Lead Experience Simulator & Conversation Viewer | - | not_started | 2 | - | PM > Design > Dev > QC |
...
| UC-LANDING-ANALYTICS-GA4-001 | Landing Page Analytics — GA4 CTA & Conversion Tracking | - | not_started | 2 | - | PM > Design > Dev > QC |
