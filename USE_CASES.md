...
> Generated: 2026-03-13T15:52:05.850Z | Source: `use_cases` + `prds` tables

**Progress: 144/149 complete**
...
| fix-touchsession-middleware-not-implemented-no-session | touchSession() middleware not implemented — no session heartbeat | - | needs_merge | 1 | - | Dev > QC |
...
| fix-prd-md-files-remain-at-docs-root-instead-of-docs-p | PRD-*.md files remain at docs/ root instead of docs/prd/ | - | needs_merge | 2 | - | Dev > QC |
