...
> Generated: 2026-03-10T22:35:18.544Z | Source: `use_cases` + `prds` tables
...
| fix-nps-api-routes-api-nps-verify-and-api-nps-submit-r | NPS API routes /api/nps/verify and /api/nps/submit return 404 | - | in_progress | 1 | - | Dev > QC |
