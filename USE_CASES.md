...
> Generated: 2026-03-12T06:15:11.892Z | Source: `use_cases` + `prds` tables

**Progress: 130/139 complete**
...
| fix-no-self-serve-upgrade-path-from-pilot-to-paid | No self-serve upgrade path from pilot to paid | - | in_progress | 1 | - | Dev > QC |
