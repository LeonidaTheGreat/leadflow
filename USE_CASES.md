...
> Generated: 2026-04-04T05:17:35.470Z | Source: `use_cases` + `prds` tables

**Progress: 203/438 complete**
...
| feat-trial-expiry-conversion-drip | Trial Expiry Conversion Drip — Automated Email + In-App Upgrade Nudge | Phase 2 | not_started | 0 | - | PM > Dev > QC |
| feat-guided-fub-onboarding-wizard | Guided FUB Onboarding Wizard — Connect CRM in <5 Minutes | Phase 2 | not_started | 0 | - | PM > Dev > QC |
...
| feat-weekly-roi-activity-email | Weekly ROI Activity Email — Prove Value Before Trial Expires | Phase 2 | not_started | 0 | - | PM > Dev > QC |
...
| fix-feature-not-deployed-all-new-routes-return-404-on- | Feature not deployed — all new routes return 404 on Vercel | - | not_started | 0 | - | Dev > QC |
| uc-first-paid-customer-proof | Critical: Get First Trial User to Paid (Proof of Concept) | Phase 3 | not_started | 0 | - | PM |
...
| feat-trial-to-paid-conversion-sprint | Trial-to-Paid Conversion Sprint — Fix Stripe + Email Sequence for 367 Trial Users | Phase 2 | not_started | 0 | - | PM > Dev > QC |
| feat-pilot-activation-white-glove | Pilot Activation White-Glove Onboarding — Convert 11 Pilots to Active and Paid | Phase 2 | not_started | 0 | - | PM > Dev > QC |
...
| feat-activation-roi-proof-email | Weekly AI Activity Report — Prove ROI to Every Trial User Before They Churn | Phase 2 | not_started | 0 | - | PM > Dev > QC |
| UC-REVENUE-RECOVERY-CRITICAL | Revenue Recovery — Close MRR Gap (Critical Alert) | Phase 3 | in_progress | 0 | - | PM > Dev > QC |
...
| uc-trial-email-sequence-activate | Activate Pilot-to-Paid Email Sequence for Trial Users | Phase 3 | not_started | 1 | - | PM > Dev > QC |
...
| feat-stripe-keys-vercel | Deploy Stripe API keys to Vercel production | revenue-emergency | ready | 1 | - | PM > Dev > QC |
...
| uc-smoke-loop-fix-v3 | Fix Smoke Handler Loop — findLatestTaskByTitle + lastTaskCreated Cooldown | Phase 1 | not_started | 1 | defined | PM > Dev > QC |
| uc-dashboard-trial-countdown | Dashboard: Trial Expiration Countdown & Upgrade CTA | Phase 3 | not_started | 1 | - | Design > Dev > QC |
| uc-trial-countdown-widget | Dashboard: Trial Countdown & Upgrade CTA | Phase 3 | ready | 1 | defined | PM > Dev > QC |
...
| fix-session-token-consistency | Standardize auth cookie names across signup/login/checkout flows | revenue-emergency | ready | 1 | - | PM > Dev > QC |
...
| fix-smoke-auth-signup-login-loop | Fix Auth Smoke Test Loop (signup_login_flow) | - | in_progress | 1 | - | PM > Dev > QC |
...
| uc-pricing-page-conversion-refresh | Pricing Page: Testimonials + Feature Comparison + Urgency | Phase 3 | not_started | 1 | - | Marketing > Design > Dev > QC |
| uc-auto-trigger-onboarding-post-verify | Auto-Trigger Onboarding Wizard After Email Verification | stabilization | not_started | 1 | - | PM > Dev > QC |
| uc-loop-cooldown-24h | GENOME: Add 24h cooldown to loop detector meta-task creation | ready | not_started | 1 | - | PM > Dev > QC |
| fix-onboarding-wizard-blocks-dashboard | Unblock agents from onboarding wizard → allow direct dashboard access | revenue-emergency | ready | 1 | - | PM > Dev > QC |
| fix-landing-page-has-no-links-to-signup-or-o | landing page has no links to signup or onboarding pages | - | complete | 1 | - | Dev > QC |
| uc-email-verification-audit | Email Verification Audit — Root Cause Analysis | Phase 3 | not_started | 1 | - | PM > Dev > QC |
| uc-dedup-key-migration | Add dedup_key Schema Migration | ready | not_started | 1 | defined | PM > Dev > QC |
| uc-email-verification-fix-delivery | Fix Email Verification — Delivery & Link Logic | Phase 3 | not_started | 1 | - | PM > Dev > QC |
| uc-email-verification-ux-prompt | Add Email Verification Prompt to Dashboard | Phase 3 | not_started | 1 | - | PM > Dev > QC |
| uc-trial-expiration-countdown | Trial Countdown & Expiration Logic | Phase 3 | not_started | 1 | - | PM > Dev > QC |
| uc-trial-to-paid-conversion | Trial → Paid Conversion: Stripe Checkout & Subscription | Phase 3 | not_started | 1 | - | PM > Dev > QC |
| uc-phase1-manual-pilot-onboarding | Phase 1: Manual Pilot Onboarding (3 Agents to Pro Tier) | pilot | ready | 1 | - | PM > Marketing > QC |
| uc-phase2-aha-moment-simulator | Phase 2A: Aha Moment Simulator Integration into Onboarding | stabilization | ready | 1 | - | PM > Design > Dev > QC |
| uc-phase2-self-serve-upgrade | Phase 2B: Self-Serve Upgrade Flow (Stripe Checkout + Trial Countdown) | stabilization | ready | 1 | - | PM > Design > Dev > QC |
...
| uc-task-timeout-reaper | GENOME: Auto-timeout stuck PM tasks after 30min | ready | not_started | 1 | - | PM > Dev > QC |
| uc-revenue-alert-resolution | Revenue Alert Resolution — Close $20K MRR Gap | Phase 3 | not_started | 1 | - | PM > Orchestrator > Dev > QC |
| uc-revenue-alert-dedup | Revenue Alert Task Deduplication | Phase 1 | ready | 1 | defined | PM > Design > Dev > QC |
| fix-distribution-loop | Fix: Distribution loop — deduplicate task creation with 7-day cooldown | implementation | not_started | 1 | defined | PM > Dev > QC |
| UC-ONBOARDING-MOBILE-FIRST | Mobile-First Onboarding Redesign — Fix 86% Drop-Off | Phase 1 | not_started | 1 | - | PM > Design > Dev > QC |
| uc-revenue-critical-2026-q1 | Revenue Alert Critical — Close $20K MRR Gap | pilot | ready | 1 | - | PM > Dev > QC |
| UC-ONBOARDING-COMPLETION-BASELINE | Onboarding Completion Rate Baseline & Drop-Off Analysis | Phase 2 | not_started | 1 | - | PM > Analytics > Dev |
| uc-marketing-campaign-launch | Launch Acquisition Campaign — Signups 10+/Day Minimum | Phase 2 | not_started | 1 | defined | PM > Marketing > Dev > QC |
| uc-revenue-recovery-critical-2026-03-31 | Revenue Recovery — Critical MRR Action Plan | pilot | not_started | 1 | defined | PM > Dev > QC |
| uc-distribution-loop-fix | Fix Distribution Health Loop — Stop Repeated Landing Page Task Spawning | specification | not_started | 1 | - | Dev > QC |
| UC-TRIAL-EMAIL-SEQUENCE-V2 | Trial-to-Paid Email Sequence | Phase 2 | not_started | 1 | - | PM > Marketing > Design > Dev > QC |
| UC-LANDING-PAGE-ANALYTICS-V2 | Landing Page Analytics & Attribution Tracking | Phase 2 | not_started | 1 | - | PM > Analytics > Dev > QC |
...
| fix-admin-simulator-unprotected-http-200-to-unauthenti | Admin simulator unprotected — HTTP 200 to unauthenticated requests | - | not_started | 1 | - | Dev > QC |
...
| uc-loop-detection-handler-fix | Fix Loop Detection Handler Duplicate Investigations | specification | in_progress | 1 | - | PM > Dev > QC |
...
| fix-next-public-api-url-missing-rest-v1-all-db-operati | NEXT_PUBLIC_API_URL missing /rest/v1 — all DB operations fail in production | - | not_started | 1 | - | Dev > QC |
| fix-zero-real-pilot-recruitment-at-day-43-90 | Zero real pilot recruitment at Day 43/90 | - | not_started | 1 | - | Dev > QC |
| fix-stripe-not-configured-in-vercel-paid-conversion-re | Stripe not configured in Vercel — paid conversion returns 503 | - | not_started | 1 | - | Dev > QC |
| fix-no-trial-to-paid-conversion-sequence-trials-expire | No trial-to-paid conversion sequence — trials expire silently | - | not_started | 1 | - | Dev > QC |
...
| fix-feedback-api-500-schema-mismatch | Fix Feedback API 500 Error — Schema Mismatch in product_feedback Insert | Phase 1 | not_started | 1 | - | Dev > QC |
| fix-stripe-billing-completely-broken-placeholder-price | Stripe billing completely broken — placeholder price IDs and missing checkout API | - | not_started | 1 | - | Dev > QC |
...
| fix-distribution-collector-js-still-queries-http-local | distribution-collector.js still queries http://localhost:8787 (PostgREST) — returns Not Found for all table queries | - | not_started | 1 | - | Dev > QC |
| fix-stripe-webhook-handler-uses-agent-id-but-subscript | Stripe webhook handler uses agent_id but subscriptions table has user_id column | - | not_started | 1 | - | Dev > QC |
| fix-api-lead-capture-still-returns-500-in-production | /api/lead-capture still returns 500 in production | - | complete | 1 | - | Dev > QC |
| uc-trial-to-paid-conversion-path | Implement Trial-to-Paid Conversion Path with Self-Serve Checkout | Phase 3 | ready | 1 | - | Dev > QC |
...
| uc-revenue-collector-dedup | Revenue Collector Deduplication | Phase 1 | not_started | 1 | - | Dev > QC > PM |
...
| fix-stripe-not-configured-in-vercel-367-trial-users-ca | Stripe not configured in Vercel — 367 trial users cannot upgrade to paid | - | not_started | 1 | - | Dev > QC |
| fix-367-trial-accounts-0-mrr-no-trial-to-paid-conversi | 367 trial accounts, $0 MRR — no trial-to-paid conversion mechanism exists | - | not_started | 1 | - | Dev > QC |
| fix-11-pilots-with-no-aha-moment-warmest-leads-going-c | 11 pilots with no aha moment — warmest leads going cold | - | not_started | 1 | - | Dev > QC |
...
| fix-sequences-not-paused-when-lead-responds-via-sms | Sequences NOT paused when lead responds via SMS | - | not_started | 1 | - | Dev > QC |
| uc-landing-e2e-post-cta-001 | Full E2E Suite Validation — Post Landing Page CTA Integration | Phase 1 | not_started | 1 | defined | QC |
...
| fix-db-migration-not-run-agents-table-missing-utm-colu | DB migration not run — agents table missing UTM columns | - | not_started | 1 | - | Dev > QC |
| fix-test-gateway-path | test gateway path | - | complete | 1 | - | Dev > QC |
| uc-action-1-loop-detection-fix | Action 1: Fix Loop Detection System | Phase 3 | not_started | 1 | - | Orchestrator > QC |
| fix-sequences-not-paused-when-lead-responds-inbound-sm | Sequences not paused when lead responds (inbound SMS) | - | not_started | 1 | - | Dev > QC |
| fix-sequences-not-paused-when-lead-books-appointment | Sequences not paused when lead books appointment | - | not_started | 1 | - | Dev > QC |
| fix-first-session-sample-leads-fr-4-not-implemented | First-session sample leads (FR-4) not implemented | - | complete | 1 | - | Dev > QC |
| fix-api-endpoint-uses-non-existent-column-twilio-statu | API endpoint uses non-existent column twilio_status | - | not_started | 1 | - | Dev > QC |
...
| uc-onboarding-mandatory-auto-trigger | Auto-Trigger Onboarding Wizard on First Login | Phase 3 | ready | 1 | defined | PM > Dev > QC |
...
| fix-next-js-dashboard-not-deployed-vercel-rootdirector | Next.js dashboard not deployed — Vercel rootDirectory misconfigured | - | not_started | 1 | - | Dev > QC |
| fix-live-site-serves-api-json-instead-of-next-js-dashb | Live site serves API JSON instead of Next.js dashboard — pricing section invisible to users | - | not_started | 1 | - | Dev > QC |
...
| fix-leadmagnetsection-not-integrated-into-landing-page | LeadMagnetSection not integrated into landing page | - | not_started | 1 | - | Dev > QC |
| fix-api-lead-capture-endpoint-returns-404-in-productio | /api/lead-capture endpoint returns 404 in production | - | not_started | 1 | - | Dev > QC |
| uc-smoke-loop-fix-001 | Smoke Test Loop Prevention and Health Endpoint Accuracy | Phase 1 | not_started | 1 | defined | PM > Dev > QC |
...
| fix-next-js-dashboard-not-deployed-admin-simulator-and | Next.js dashboard not deployed — /admin/simulator and all Next.js routes return 404 | - | not_started | 1 | - | Dev > QC |
| fix-all-3-simulator-api-endpoints-return-404-e2e-tests | All 3 simulator API endpoints return 404 — E2E tests fail 8/11 | - | not_started | 1 | - | Dev > QC |
| fix-stripe-secret-key-not-set-in-vercel-production | STRIPE_SECRET_KEY not set in Vercel production | - | complete | 1 | - | Dev > QC |
| fix-leadflow-ai-five-vercel-app-serving-fub-webhook-ap | leadflow-ai-five.vercel.app serving FUB Webhook API — customer dashboard not deployed | - | not_started | 1 | - | Dev > QC |
...
| uc-pilot-recruitment-unblock | Action 1: Unblock Real Pilot Recruitment | pilot | ready | 1 | - | PM > Dev > QC |
| uc-sample-leads-auto-populate | Auto-Populate Sample Leads (5 per Agent) | Phase 3 | ready | 1 | defined | PM > Dev > QC |
| uc-trial-to-paid-conversion-flow | Trial-to-Paid Email Sequence & Stripe Checkout Integration | stabilization | not_started | 1 | - | PM > Dev > QC |
| uc-manual-pilot-recruitment | Manual Pilot Recruitment — 5 Real Agents, White-Glove Onboarding | recruitment | not_started | 1 | - | PM > Dev > QC |
| uc-onboarding-restore-001 | Fix Post-Signup Onboarding Wizard | Phase 3 | ready | 1 | - | Dev > QC |
| fix-demo-page-not-deployed-to-production | Demo page not deployed to production | - | not_started | 1 | - | Dev > QC |
| fix-landing-page-has-no-pricing-section | Landing page has NO pricing section | - | complete | 1 | - | Dev > QC |
| fix-trial-signup-bypasses-email-verification-gate-enti | Trial signup bypasses email verification gate entirely | - | not_started | 1 | - | Dev > QC |
...
| uc-stripe-checkout-fix | Action 2: Fix Stripe Checkout Production Bug | pilot | ready | 1 | - | PM > Dev > QC |
| deploy-nextjs-dashboard-correct-url | Deploy & Verify Next.js Customer Dashboard to Vercel | Phase 1 | not_started | 1 | - | Dev > QC > PM |
| fix-next-js-customer-dashboard-not-accessible-at-any-p | Next.js customer dashboard not accessible at any public URL | - | not_started | 1 | - | Dev > QC |
...
| fix-next-js-customer-dashboard-not-deployed-billing-ro | Next.js customer dashboard NOT deployed — billing routes return 404 | - | not_started | 1 | - | Dev > QC |
...
| fix-stripe-secret-key-and-stripe-webhook-secret-confir | STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET confirmed missing from Vercel production | - | not_started | 1 | - | Dev > QC |
| fix-next-js-dashboard-not-deployed-at-leadflow-ai-five | Next.js dashboard not deployed at leadflow-ai-five.vercel.app | - | not_started | 1 | - | Dev > QC |
| uc-action-2-onboarding-wizard | Action 2: Force Onboarding Wizard Completion | Phase 3 | not_started | 1 | - | Dev > QC |
| fix-stripe-webhook-integration | Verify Stripe webhook processes subscription.created and updates agent records | revenue-emergency | ready | 1 | - | PM > Dev > QC |
| fix-next-js-dashboard-not-deployed-all-admin-invite-ui | Next.js dashboard not deployed — all admin invite UI routes return 404 | - | not_started | 1 | - | Dev > QC |
...
| fix-server-side-stripe-price-env-vars-missing-only-nex | Server-side STRIPE_PRICE_* env vars missing — only NEXT_PUBLIC_ variants exist | - | not_started | 1 | - | Dev > QC |
| uc-action-3-test-lead-distribution | Action 3: Enable Test Lead Distribution to Pilots | Phase 3 | not_started | 1 | - | Dev > QC |
| fix-accept-invite-does-not-create-auth-session-agents- | accept-invite does not create auth session — agents cannot reach onboarding after accepting | - | not_started | 1 | - | Dev > QC |
| fix-loop-handler-distribution-dedup | Fix Loop Detection & Distribution Collector Dedup | - | not_started | 1 | - | PM > Dev > QC |
| uc-email-verification-unblock | Fix Email Verification Pipeline — Unlock All 386 Trial Agents | Phase 3 | ready | 1 | - | Dev > QC |
| fix-4-consecutive-production-deployment-failures-in-le | 4 consecutive production deployment failures in leadflow-ai Vercel project | - | not_started | 1 | - | Dev > QC |
| uc-nurture-seq-scheduler-vercel-cron-001 | Implement: Nurture sequence scheduling via Vercel Cron | Phase 2 - Nurture Automation | not_started | 1 | - | Dev > QC |
| deploy-dashboard-vercel-cli | Deploy Dashboard via Vercel CLI | Phase 1 | not_started | 1 | - | Dev > QC |
| uc-real-agent-filter | Action 3: Real-Agent Isolation Filter | pilot | ready | 1 | - | PM > Dev > QC |
| UC-11 | Subscription Lifecycle | Phase 3 | complete | 1 | defined | PM > Dev > QC |
| fix-hardcoded-agentid-use-auth-session | Fix hardcoded agentId — read real agent ID from auth session | Phase 2 | not_started | 1 | - | Dev > QC |
| uc-onboarding-aha-moment-auto | Auto-Trigger Onboarding Wizard & Implement Aha Moment Demo | Phase 3 | ready | 1 | - | Dev > QC |
| fix-webhook-handler-uses-agent-id-instead-of-user-id-f | Webhook handler uses agent_id instead of user_id for subscription_events inserts | - | not_started | 1 | - | Dev > QC |
| fix-api-cron-nurture-emails-endpoint-does-not-exist | /api/cron/nurture-emails endpoint does not exist | - | not_started | 1 | - | Dev > QC |
| fix-vercel-json-does-not-configure-nurture-emails-cron | vercel.json does not configure nurture-emails cron schedule | - | not_started | 1 | - | Dev > QC |
| fix-day-3-and-day-7-email-queries-not-implemented | Day 3 and Day 7 email queries not implemented | - | not_started | 1 | - | Dev > QC |
...
| uc-fix-email-verification-day47 | Fix Email Verification Pipeline | Critical Path | ready | 1 | defined | Dev > QC |
| uc-auto-trigger-onboarding-day47 | Auto-Trigger Onboarding Wizard | Critical Path | ready | 1 | defined | Dev > QC |
| uc-enable-trial-to-paid-checkout-day47 | Enable Trial-to-Paid Conversion (Checkout + Email) | Critical Path | ready | 1 | defined | Dev > QC |
| uc-trial-activation-email-sequence | First-Login Welcome Email Sequence | Phase 3 | ready | 1 | defined | PM > Dev > QC |
...
| uc-trialsignupform-landing-integration | TrialSignupForm Landing Page Integration — Fix CSR Rendering & Verify E2E Signup Flow | Phase 1 | not_started | 1 | - | Dev > QC |
...
| uc-revenue-alert-loop-dedup | Fix Revenue Alert Task Loop — Deduplication | ready | not_started | 1 | defined | PM > Dev > QC |
| uc-fix-onboarding-aha-moment | Fix Onboarding Wizard Aha Moment — Live Lead Simulator | stabilization | not_started | 1 | - | PM > Dev > QC |
...
| UC-REVENUE-RECOVERY-IMMEDIATE-D47 | Revenue Recovery — Immediate Priority Actions (Day 47) | Phase 3 | in_progress | 1 | - | PM > Orchestrator > Marketing > Dev > QC |
...
| feat-checkout-page-stripe-elements | Create functional checkout page with Stripe Elements integration | revenue-emergency | ready | 1 | - | PM > Dev > QC |
...
| uc-fix-smoke-loop | Fix: Smoke test loop — Vercel dashboard health tasks duplicating infinitely | pilot | in_progress | 1 | - | Dev |
...
| fix-resend-api-key-missing-from-vercel-playbook-email- | RESEND_API_KEY missing from Vercel — playbook email delivery broken | - | not_started | 2 | - | Dev > QC |
...
| gtm-landing-page | Landing Page | - | complete | 2 | defined | PM > Marketing > Design > Dev > QC |
...
| email-campaign-trial-ready | Email campaign: "Your trial is ready — unlock unlimited AI responses" | revenue-emergency | ready | 2 | - | PM > Dev > QC |
...
| dashboard-trial-activation-sequence | Add trial activation sequence: aha moment (day 1), upgrade CTA (day 3), urgency (day 10-13) | revenue-emergency | ready | 2 | - | PM > Dev > QC |
...
| uc-trial-countdown-001 | Dashboard Trial Expiration Countdown | Phase 3 | ready | 2 | - | Dev > QC |
...
| uc-trial-email-sequence-002 | Automated Trial-to-Paid Conversion Emails | Phase 3 | ready | 2 | - | Dev > QC |
...
| uc-action-4-funnel-analytics | Action 4: Measure Pilot Conversion Funnel | Phase 3 | not_started | 2 | - | Analytics > PM |
...
| sales-outreach-active-agents | Personal sales outreach to 10 "active" status agents — convert 3-5 to Team tier | revenue-emergency | ready | 2 | - | PM > Dev > QC |
...
| fix-ga4-tracking-complete | Complete GA4 instrumentation: scroll depth, CTA clicks, checkout page views | revenue-emergency | ready | 2 | - | PM > Dev > QC |
| uc-loop-auth-failure-guard | GENOME: Guard loop detection against auth failures | ready | not_started | 2 | - | PM > Dev > QC |
| uc-phase2-trial-expiry-emails | Phase 2C: Trial Expiry Email Sequence & Upgrade Links | stabilization | ready | 2 | - | PM > Marketing > Dev > QC |
| uc-phase2-ga4-analytics | Phase 2D: GA4 Conversion Funnel Analytics | analytics | ready | 2 | - | PM > Dev > QC |
| fix-conversations-viewer-broken-supabase-env-vars-miss | Conversations Viewer broken — SUPABASE env vars missing on Vercel | - | not_started | 2 | - | Dev > QC |
| fix-demo-link-generation-fails-db-env-vars-missing-on- | Demo link generation fails — DB env vars missing on Vercel | - | not_started | 2 | - | Dev > QC |
| fix-simulations-not-persisted-lead-simulations-write-f | Simulations not persisted — lead_simulations write fails in production | - | not_started | 2 | - | Dev > QC |
| fix-middleware-does-not-call-touchsession-logpageview- | Middleware does not call touchSession()/logPageView() — FR-2 and FR-3 not wired up | - | not_started | 2 | - | Dev > QC |
| fix-guided-fub-activation-not-implemented-agents-canno | Guided FUB activation not implemented — agents cannot realize core value | - | not_started | 2 | - | Dev > QC |
| fix-no-roi-proof-loop-agents-have-no-reason-to-upgrade | No ROI proof loop — agents have no reason to upgrade | - | not_started | 2 | - | Dev > QC |
| fix-trialsignupform-missing-form-funnel-events-form-op | TrialSignupForm missing form funnel events (form_open, form_submit, form_success, form_error) | - | not_started | 2 | - | Dev > QC |
| fix-leadsatisfactioncard-uses-hardcoded-test-agent-id- | LeadSatisfactionCard uses hardcoded test-agent-id in dashboard page | - | not_started | 2 | - | Dev > QC |
| fix-ga4-tracking-id-is-g-test-placeholder-zero-marketi | GA4 tracking ID is G-TEST-PLACEHOLDER — zero marketing analytics | - | not_started | 2 | - | Dev > QC |
| fix-admin-simulator-cannot-persist-conversations-datab | Admin simulator cannot persist conversations — database save failing | - | not_started | 2 | - | Dev > QC |
| fix-multiple-production-env-vars-have-trailing-newline | Multiple production env vars have trailing newline characters | - | not_started | 2 | - | Dev > QC |
| fix-main-landing-page-ctas-have-no-analytics-tracking- | Main landing page CTAs have no analytics tracking wired | - | not_started | 2 | - | Dev > QC |
| fix-scroll-depth-intersectionobservers-not-implemented | Scroll depth IntersectionObservers not implemented on main landing page | - | not_started | 2 | - | Dev > QC |
| fix-next-public-ga4-measurement-id-not-set-ga4-script- | NEXT_PUBLIC_GA4_MEASUREMENT_ID not set — GA4 script disabled everywhere | - | not_started | 2 | - | Dev > QC |
| fix-how-it-works-section-not-implemented-ac-2 | How It Works section not implemented (AC-2) | - | not_started | 2 | - | Dev > QC |
| fix-fub-integration-ui-exists-but-connection-flow-not- | FUB integration UI exists but connection flow not verified | - | not_started | 2 | - | Dev > QC |
| fix-hero-cta-renders-blank-primary-conversion-cta-invi | Hero CTA renders blank — primary conversion CTA invisible on landing page | - | not_started | 2 | - | Dev > QC |
| fix-api-connectivity-degraded-dashboard-cannot-display | API connectivity degraded — dashboard cannot display live data | - | not_started | 2 | - | Dev > QC |
| fix-cron-schedule-is-daily-10am-not-hourly-defeats-sub | Cron schedule is daily (10am), not hourly — defeats sub-24h delay sequences | - | not_started | 2 | - | Dev > QC |
| fix-production-endpoint-api-cron-follow-up-returns-404 | Production endpoint /api/cron/follow-up returns 404 on Vercel | - | not_started | 2 | - | Dev > QC |
| fix-trial-signup-form-reads-utm-from-url-params-not-se | trial-signup-form reads UTM from URL params, not sessionStorage — breaks first-touch attribution | - | not_started | 2 | - | Dev > QC |
| fix-only-3-of-5-utm-params-captured-end-to-end-missing | Only 3 of 5 UTM params captured end-to-end (missing utm_content, utm_term) | - | not_started | 2 | - | Dev > QC |
| fix-no-global-sequences-dashboard-view | No global sequences dashboard view | - | not_started | 2 | - | Dev > QC |
| fix-two-tests-failing-in-sms-stats-test-ts | Two tests failing in sms-stats.test.ts | - | not_started | 2 | - | Dev > QC |
| fix-active-setup-wizard-missing-twilio-phone-provision | Active /setup wizard missing Twilio phone provisioning step (US-3) | - | not_started | 2 | - | Dev > QC |
| fix-sms-verify-tsx-calls-deprecated-endpoint-sms-verif | sms-verify.tsx calls deprecated endpoint — sms_verified never written to DB | - | not_started | 2 | - | Dev > QC |
| fix-form-funnel-events-never-fired-trackformevent-impo | Form funnel events never fired — trackFormEvent imported but not called | - | not_started | 2 | - | Dev > QC |
| fix-ga4-measurement-id-is-placeholder-g-test-placehold | GA4 Measurement ID is placeholder G-TEST-PLACEHOLDER — no data collection | - | not_started | 2 | - | Dev > QC |
| fix-form-funnel-events-never-fire-trackformevent-impor | Form funnel events never fire — trackFormEvent imported but not called | - | not_started | 2 | - | Dev > QC |
| fix-ga4-measurement-id-is-g-test-placeholder-no-analyt | GA4 Measurement ID is G-TEST-PLACEHOLDER — no analytics data flows | - | not_started | 2 | - | Dev > QC |
| fix-leadflow-ai-vercel-project-has-3-consecutive-faili | leadflow-ai Vercel project has 3+ consecutive failing production deployments | - | not_started | 2 | - | Dev > QC |
| fix-day-3-7-nurture-emails-have-no-scheduler | Day 3/7 nurture emails have no scheduler | - | not_started | 2 | - | Dev > QC |
| fix-satisfaction-ping-route-still-queries-deprecated-a | satisfaction-ping route still queries deprecated agents table | - | not_started | 2 | - | Dev > QC |
| fix-pilot-usage-endpoint-uses-api-secret-key-auth-inst | pilot-usage endpoint uses API_SECRET_KEY auth instead of SUPABASE_SERVICE_ROLE_KEY | - | not_started | 2 | - | Dev > QC |
| fix-confirmation-tsx-does-not-show-aha-moment-status-i | confirmation.tsx does not show Aha Moment status in Connected Integrations | - | not_started | 2 | - | Dev > QC |
| fix-anthropic-api-key-not-configured | ANTHROPIC_API_KEY not configured | - | not_started | 2 | - | Dev > QC |
| fix-pilot-signup-sets-email-verified-true-on-creation- | Pilot signup sets email_verified: true on creation, bypassing login gate | - | not_started | 2 | - | Dev > QC |
| feat-canonical-wizard-setup-swap | Canonical Wizard: Swap Components in /setup Route | MVP | ready | 2 | defined | PM > Dev > QC |
| fix-project-config-json-dashboard-smoke-test-url-incor | project.config.json dashboard smoke test URL incorrect | - | not_started | 2 | - | Dev > QC |
| fix-url-mismatch-leadflow-ai-five-vercel-app-hosts-fub | URL mismatch: leadflow-ai-five.vercel.app hosts FUB webhook, not customer dashboard | - | not_started | 2 | - | Dev > QC |
| fix-env-var-naming-inconsistency-pro-vs-professional-b | Env var naming inconsistency: PRO vs PROFESSIONAL between checkout and webhook routes | - | not_started | 2 | - | Dev > QC |
| fix-url-routing-mismatch-leadflow-ai-five-vercel-app-s | URL routing mismatch: leadflow-ai-five.vercel.app serves Express, not Next.js dashboard | - | not_started | 2 | - | Dev > QC |
| fix-lead-detail-page-uses-old-conversationview-not-the | Lead detail page uses old ConversationView, not the new ConversationViewV2 with UC-7 integration | - | not_started | 2 | - | Dev > QC |
| fix-cron-endpoint-uses-postgrest-client-not-service-ro | Cron endpoint uses PostgREST client not service role key | - | not_started | 2 | - | Dev > QC |
| fix-product-feedback-insert-missing-processed-false-an | product_feedback insert missing processed:false and wrong data schema | - | not_started | 2 | - | Dev > QC |
| fix-fix-confirmed-subscription-attempts-replaced-with- | Fix confirmed: subscription_attempts replaced with checkout_sessions | - | not_started | 2 | - | Dev > QC |
| fix-return-value-mismatch-returns-success-alerts-creat | Return value mismatch: returns {success, alerts_created} not {inserted, skipped} | - | not_started | 2 | - | Dev > QC |
| fix-no-http-endpoint-fr-5-5-and-ac-7-not-implemented | No HTTP endpoint — FR-5.5 and AC-7 not implemented | - | not_started | 2 | - | Dev > QC |
| fix-idempotency-dedup-logic-not-defined | Idempotency/dedup logic not defined | - | not_started | 2 | - | Dev > QC |
| fix-satisfaction-patterns-missing-keywords | Fix SATISFACTION_PATTERNS — missing ANNOYING, QUIT, MEH keywords | Phase 1 | not_started | 2 | - | Dev > QC |
| fix-satisfaction-ping-route-ts-still-queries-agents-ta | satisfaction-ping/route.ts still queries agents table instead of real_estate_agents | - | not_started | 2 | - | Dev > QC |
| fix-email-templates-not-integrated | Email templates not integrated | - | not_started | 2 | - | Dev > QC |
| feat-frictionless-demo-no-fub | Frictionless Demo Mode — See AI Respond in 60 Seconds (No FUB Required) | - | not_started | 2 | - | PM > Dev > QC |
| uc-cta-click-tracking-landing-page | Wire CTA Click Tracking on Landing Page (page.tsx) | pilot | complete | 2 | pass | QC |
| decommission-legacy-twilio-inbound-handler | Decommission legacy integrations/twilio-inbound-sms.js handler | pilot | not_started | 2 | - | Dev > QC |
| uc-pricing-conversion-003 | Pricing Page Trial User Optimization | Phase 3 | ready | 3 | - | Design > Dev > QC |
| fix-stripe-subscriptions-table | Fix: Create Subscriptions Table for Stripe Webhook Storage | - | complete | 3 | - | Dev > QC |
| uc-smoke-loop-dedup | Smoke Test Loop Prevention | - | not_started | 3 | defined | PM > Dev > QC |
| feat-auto-sync-deployed-pages-to-system-compo | Auto-Sync Deployed Pages to System Components | Phase 3 | complete | 3 | - | PM > Dev > QC |
| fix-distribution-collector-task-loop | Fix Distribution Collector — Prevent Repeated Task Creation (Loop Bug) | Phase 2 | not_started | 3 | - | Dev > QC |
...
### uc-smoke-loop-fix-v3 — Fix Smoke Handler Loop — findLatestTaskByTitle + lastTaskCreated Cooldown

- **PRD:** Fix Smoke Loop V3 — findLatestTaskByTitle + lastTaskCreated Cooldown
- **Status:** not_started
- **Priority:** 1
- **Description:** Prevent infinite task creation loops in the genome heartbeat smoke handler. The handler uses findTaskByTitle which excludes completed tasks, making dedup/escalation/cooldown permanently broken. Three code changes in genome files (task-store.js + heartbeat-executor.js) will fix this permanently.
- **Acceptance Criteria:**
  - findLatestTaskByTitle() method added to ~/.openclaw/genome/core/task-store.js
  - Lines 2317-2318 of heartbeat-executor.js updated to use findLatestTaskByTitle
  - lastTaskCreated written to smoke state after spawning QC task
  - Cooldown check uses lastTaskActivity = lastTaskCompleted || lastTaskCreated
  - 10 consecutive heartbeats with failing vercel-dashboard produce at most 1 new QC task
  - After QC task completes, next heartbeat creates Fix: dev task (not another Smoke: task)
  - ~/.openclaw/genome/state/leadflow/.smoke-test-state.json shows lastTaskCreated for vercel-dashboard
- **Workflow:** PM > Dev > QC
...
### uc-revenue-alert-dedup — Revenue Alert Task Deduplication

- **PRD:** Revenue Alert Task Deduplication
- **Status:** ready
- **Priority:** 1
- **Description:** Prevent duplicate PM: Revenue alert tasks from being created every heartbeat when MRR is off-track. Add deduplication logic to revenue-collector.js to check if an active task already exists before creating a new one.
- **Acceptance Criteria:**
  - No duplicate revenue alert tasks in ready status after back-to-back heartbeats with same MRR data
  - Loop detector does not trigger when revenue is off-track for extended period
  - Deduplication logs present in revenue-collector output
  - New alerts created when trajectory changes (e.g., behind → critical)
  - Completed tasks do not block creation of new alerts
- **Workflow:** PM > Design > Dev > QC

### UC-ONBOARDING-MOBILE-FIRST — Mobile-First Onboarding Redesign — Fix 86% Drop-Off

- **PRD:** Mobile-First Onboarding Redesign — Fix 86% Drop-Off
- **Status:** not_started
- **Priority:** 1
- **Description:** Redesign onboarding UX for mobile devices, simplify form validation, add error handling for 2G/4G networks. Target: 50%+ completion rate.
- **Acceptance Criteria:**
  - Mobile rendering: no horizontal scroll on 375px viewport
  - Form validation: errors appear inline with clear messages
  - Network resilience: FUB timeout after 30s with retry mechanism
  - Aha moment: accessible and readable on mobile
  - ≥50% completion rate for real agents within 7 days
- **Workflow:** PM > Design > Dev > QC

### fix-feedback-api-500-schema-mismatch — Fix Feedback API 500 Error — Schema Mismatch in product_feedback Insert

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** POST /api/feedback always returns 500 because nps-service.ts inserts columns (content, metadata, is_processed) that do not exist in the product_feedback table. The table uses data (JSONB), processed (boolean), and requires project_id. The fix is to update submitProductFeedback() and createChurnRiskAlert() in nps-service.ts to use the correct schema.
- **Acceptance Criteria:**
  - POST /api/feedback with valid session, feedbackType, and content returns HTTP 200 with { success: true, feedbackId: <uuid> }
  - product_feedback row inserted with correct columns: agent_id, source=agent_self_report, feedback_type, data={content, metadata}, processed=false, project_id=leadflow
  - POST /api/feedback with invalid feedbackType returns HTTP 400
  - POST /api/feedback without session returns HTTP 401
  - Churn risk alert creation (createChurnRiskAlert) also uses correct schema — no 500 from NPS detractor flow
  - POST /api/feedback with content over 500 chars returns HTTP 400
- **Workflow:** Dev > QC

### uc-revenue-collector-dedup — Revenue Collector Deduplication
...
### uc-landing-e2e-post-cta-001 — Full E2E Suite Validation — Post Landing Page CTA Integration

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** After the landing page CTA consolidation (uc-landing-cta-consolidation-001) is implemented, run the full E2E test suite to verify no regressions were introduced. Validates: CTA placements, signup flow, analytics tracking, pricing display, and mobile responsiveness. This is the final quality gate before the landing page changes are considered shippable.
- **Acceptance Criteria:**
  - cd /Users/clawdbot/projects/leadflow && npm test -- --testPathPattern="e2e" exits 0 with 0 failing tests
  - fix-start-free-trial-cta-missing.test.js passes: all 3 CTA placements present in page.tsx
  - fix-ga4-script-tag-missing-from-layout-tsx-all-analyti.test.js passes: GA4 script tag present
  - Landing page loads with HTTP 200 at production URL (https://leadflow.re or Vercel preview URL)
  - Primary CTA (Start Free Trial) is present in hero section and links to /signup/trial
  - Secondary pilot link present and links to /pilot
  - No /signup?mode=trial URLs remain (all migrated to /signup/trial)
  - Pricing section renders all 4 tiers: Starter , Pro , Team , Brokerage 
  - Mobile viewport (375px): primary CTA is full-width, no horizontal overflow
  - npm test -- --testPathPattern="landing" exits 0 (all landing-page-related tests pass)
- **Depends on:** uc-landing-cta-consolidation-001
- **Workflow:** QC

### uc-smoke-loop-fix-001 — Smoke Test Loop Prevention and Health Endpoint Accuracy
...
- **Acceptance Criteria:**
  - ["signup_login_flow handler implemented in genome/health/smoke-tests.js","Handler uses crypto.randomBytes() for test email generation","Handler cleans up test user from DB on success AND failure","lastTaskCompleted written to smoke state after task completes in heartbeat-executor.js","Auth smoke test passes or fails only for real reasons (not missing handler)","No new smoke task for auth within 4h after fix (loop stopped)","Cooldown: no new task spawned if last completed < 2h ago","Auth endpoints handle signup -> login end-to-end correctly","Auth errors do not leak email existence","Test data cleanup: no smoke emails in real_estate_agents"]
- **Workflow:** PM > Dev > QC
...
### deploy-nextjs-dashboard-correct-url — Deploy & Verify Next.js Customer Dashboard to Vercel

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** The Next.js customer dashboard (product/lead-response/dashboard) has not been correctly deployed to a public Vercel URL. project.config.json references leadflow-ai-five.vercel.app as the dashboard, but that URL serves the FUB webhook API (JSON), not the Next.js UI. leadflow-ai.vercel.app serves a Vite+React stub. This UC ensures the Next.js dashboard is correctly deployed and its URL is updated across all config files.
- **Acceptance Criteria:**
  - Next.js dashboard is deployed to Vercel and accessible via a public URL
  - Root / returns the dashboard home or login page (HTML with React content, not JSON)
  - /login route returns 200 with login form
  - /dashboard route requires auth and redirects to /login if unauthenticated
  - /api/health returns {status: ok} as JSON
  - project.config.json smoke_tests updated: vercel-dashboard url points to correct Next.js URL
  - CLAUDE.md and any other config files referencing the dashboard URL are updated
  - The Vercel project for the dashboard is confirmed separate from the FUB webhook project
  - Dashboard UI loads correctly in browser (no console errors, no blank screen)
  - Human (Stojan) can access and log in via the public URL
- **Workflow:** Dev > QC > PM
...
### deploy-dashboard-vercel-cli — Deploy Dashboard via Vercel CLI

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** Deploy the LeadFlow dashboard to Vercel using the Vercel CLI. Decision 688629fa chose option b (vercel CLI deploy) for immediate, controllable deployments without GitHub integration dependency.
- **Acceptance Criteria:**
  - vercel CLI is installed and authenticated (vercel login)
  - Running "vercel --prod" from the project root deploys the dashboard successfully
  - Deployment URL is live and dashboard loads without errors
  - Environment variables are configured in Vercel project settings
  - Deployment completes in under 5 minutes
  - All API routes respond correctly on the deployed version
  - Subsequent deployments via "vercel --prod" update the live site
- **Workflow:** Dev > QC
...
### uc-trialsignupform-landing-integration — TrialSignupForm Landing Page Integration — Fix CSR Rendering & Verify E2E Signup Flow

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Decision: Integrate TrialSignupForm into landing page

**Decision ID:** 9f999cc5-1a34-4d04-8321-a8bd268a9fba
**Chosen option:** do_it — Complete landing page integration today
**Owner decision:** Do it now

## Current State
The TrialSignupForm component (compact mode) is already imported and placed in the hero section of . However:
1. The form is wrapped in a  boundary with no loading skeleton, causing BAILOUT_TO_CLIENT_SIDE_RENDERING — the form renders blank on first paint
2. Analytics events (form_open, form_submit, form_success, form_error) are not wired in the form funnel tracker

## What Must Be Done
1. Fix the Suspense/CSR rendering issue — the TrialSignupForm must render visibly on initial page load
2. Verify the form submits correctly to  and redirects to 3. Confirm GA4 form_funnel events fire (form_open on mount, form_submit on click, form_success on 200, form_error on failure)
4. Verify mobile viewport renders correctly (full-width email + password fields, submit button below)

- **Acceptance Criteria:**
  - GET / renders the hero section with a visible email input, password input, and Start Free Trial button — no blank area or Suspense fallback visible after hydration
  - POST /api/auth/trial-signup with valid email + password (8+ chars) returns 200 with token and redirectTo=/setup
  - After successful submit, browser navigates to /setup within 2 seconds
  - localStorage.getItem("leadflow_token") is set after successful signup
  - Duplicate email (409) shows inline error: An account with this email already exists. with Sign in link to /login
  - GA4 event cta_click fires with cta_id=start_trial_form when user submits the hero form
  - Mobile (375px viewport): form fields stack vertically, Submit button is full-width and tappable
  - curl https://leadflowai.com/ | grep -q "Start Free Trial" exits 0 (server-rendered text present)
  - No BAILOUT_TO_CLIENT_SIDE_RENDERING in Vercel function logs for the landing page route
- **Workflow:** Dev > QC
...
### fix-satisfaction-patterns-missing-keywords — Fix SATISFACTION_PATTERNS — missing ANNOYING, QUIT, MEH keywords

- **PRD:** Lead Satisfaction Feedback Collection
- **Status:** not_started
- **Priority:** 2
- **Description:** PRD US-2 specifies: negative replies include ANNOYING and QUIT; neutral replies include MEH. The SATISFACTION_PATTERNS constant in integration/twilio-inbound-sms.js is missing these keywords. Leads replying ANNOYING or QUIT will be classified as unclassified instead of negative; leads replying MEH will be classified as unclassified instead of neutral. Fix the regex to match the spec.
- **Acceptance Criteria:**
  - SATISFACTION_PATTERNS.negative regex matches ANNOYING (case-insensitive)
  - SATISFACTION_PATTERNS.negative regex matches QUIT (case-insensitive)
  - SATISFACTION_PATTERNS.neutral regex matches MEH (case-insensitive)
  - All existing negative keywords still match: NO, BAD, TERRIBLE, NOT HELPFUL, UNHELPFUL
  - All existing neutral keywords still match: OK, FINE, WHATEVER, OKAY, SURE
  - Unit test: classifySatisfactionReply("annoying") returns negative
  - Unit test: classifySatisfactionReply("quit") returns negative
  - Unit test: classifySatisfactionReply("meh") returns neutral
- **Workflow:** Dev > QC
...
- **PRD:** PRD-REVENUE-RECOVERY-002 — Revenue Acceleration & Pilot-to-Paid Conversion
- **Status:** not_started
- **Priority:** 0
...
- **Acceptance Criteria:**
  - API Endpoints developer table removed from /pricing page; Testimonials section added with real quotes from pilot agents (not stock); Feature comparison matrix present showing Starter | Pro | Team columns; Feature rows match PMF.md: SMS/mo, AI Qualification, Cal.com, Team Management; Pricing numbers correct and consistent with landing page ($49/$149/$399); Social proof section includes agent count and results stats; CTA buttons functional (not TODO placeholders); Mobile layout responsive (no horizontal scroll); Testimonial photos are real or use agent initials (no stock images); All prices and features match PMF.md exactly
- **Workflow:** Marketing > Design > Dev > QC

### uc-email-verification-audit — Email Verification Audit — Root Cause Analysis

- **PRD:** Revenue Alert — Critical Root Cause & Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Audit email delivery pipeline to determine why 0% of 384 agents verified email.
- **Acceptance Criteria:**
  - Root cause identified. Email delivery audited. All checks completed and documented.
- **Workflow:** PM > Dev > QC

### uc-email-verification-fix-delivery — Fix Email Verification — Delivery & Link Logic

- **PRD:** Revenue Alert — Critical Root Cause & Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Fix email delivery (Resend setup) or verification link logic to enable email verification.
- **Acceptance Criteria:**
  - Email verification works end-to-end. Test email verified. DB updated correctly.
- **Workflow:** PM > Dev > QC

### uc-email-verification-ux-prompt — Add Email Verification Prompt to Dashboard

- **PRD:** Revenue Alert — Critical Root Cause & Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Block onboarding until email verified. Show clear prompt and resend option.
- **Acceptance Criteria:**
  - Unverified agents blocked from dashboard. Modal shows verification prompt. Resend email works.
- **Workflow:** PM > Dev > QC

### uc-trial-expiration-countdown — Trial Countdown & Expiration Logic

- **PRD:** Revenue Alert — Critical Root Cause & Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Implement trial countdown, email alerts, and access blocking at expiration.
- **Acceptance Criteria:**
  - Countdown displays. Alert emails sent. Access blocked on day 14. Upgrade button visible.
- **Workflow:** PM > Dev > QC

### uc-trial-to-paid-conversion — Trial → Paid Conversion: Stripe Checkout & Subscription

- **PRD:** Revenue Alert — Critical Root Cause & Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Verify trial users can upgrade. Ensure Stripe checkout, webhook, and access unlock work.
- **Acceptance Criteria:**
  - Upgrade button works. Stripe checkout loads. Payment processes. Subscription status updates. Paid access unlocks.
- **Workflow:** PM > Dev > QC

### uc-revenue-alert-resolution — Revenue Alert Resolution — Close $20K MRR Gap

- **PRD:** Revenue Alert System — Loop Prevention & Revenue Gap Analysis
- **Status:** not_started
- **Priority:** 1
- **Description:** Fix loop detection system, force onboarding wizard, enable test lead distribution, and measure pilot conversion funnel to achieve revenue target
- **Acceptance Criteria:**
  - ["No duplicate PM revenue alert tasks created","All 5 pilots complete onboarding wizard within 24h","All 5 pilots connect FUB integration","All 5 pilots receive test leads and can respond","Conversion funnel dashboard shows >=80% completion rate"]
- **Workflow:** PM > Orchestrator > Dev > QC

### uc-trial-to-paid-conversion-path — Implement Trial-to-Paid Conversion Path with Self-Serve Checkout

- **PRD:** Revenue Alert — Critical (MRR)
- **Status:** ready
- **Priority:** 1
- **Description:** Implement self-serve Stripe checkout from dashboard. Add trial countdown banner. Deploy trial conversion email sequence (day 3, 10, 13, 14). Target: 1+ paid customer by Day 52 ($149+ MRR).
- **Workflow:** Dev > QC

### uc-action-1-loop-detection-fix — Action 1: Fix Loop Detection System

- **PRD:** Revenue Alert System — Loop Prevention & Revenue Gap Analysis
- **Status:** not_started
- **Priority:** 1
- **Description:** Prevent duplicate PM revenue alert tasks by adding dedup checks and auto-timeout for stuck tasks in orchestrator
- **Workflow:** Orchestrator > QC

### uc-onboarding-mandatory-auto-trigger — Auto-Trigger Onboarding Wizard on First Login

- **PRD:** Revenue Emergency Triage — Activation Blockage (Day 47)
- **Status:** ready
- **Priority:** 1
- **Description:** Redirect verified agents to /dashboard/onboarding on first login
- **Workflow:** PM > Dev > QC

### uc-sample-leads-auto-populate — Auto-Populate Sample Leads (5 per Agent)

- **PRD:** Revenue Emergency Triage — Activation Blockage (Day 47)
- **Status:** ready
- **Priority:** 1
- **Description:** Seed 5 realistic sample leads per agent on account creation
- **Workflow:** PM > Dev > QC
...
- **Status:** ready
- **Priority:** 1
- **Description:** Restore onboarding wizard. 80%+ of trial users stuck at step 0. Enable progression through FUB → SMS → product activation.
- **Acceptance Criteria:**
  - Post-signup redirect to /dashboard/onboarding works. Step advancement persists in DB. 50%+ of new signups reach step 1+ within 24h.
- **Workflow:** Dev > QC
...
### uc-action-2-onboarding-wizard — Action 2: Force Onboarding Wizard Completion

- **PRD:** Revenue Alert System — Loop Prevention & Revenue Gap Analysis
- **Status:** not_started
- **Priority:** 1
- **Description:** Auto-trigger wizard post-login, block dashboard until completed, track drop-off
- **Depends on:** uc-action-1-loop-detection-fix
- **Workflow:** Dev > QC

### uc-action-3-test-lead-distribution — Action 3: Enable Test Lead Distribution to Pilots

- **PRD:** Revenue Alert System — Loop Prevention & Revenue Gap Analysis
- **Status:** not_started
- **Priority:** 1
- **Description:** Fix distribution loop, enable test lead injection, create 20 test leads, track delivery
- **Depends on:** uc-action-2-onboarding-wizard
- **Workflow:** Dev > QC

### uc-email-verification-unblock — Fix Email Verification Pipeline — Unlock All 386 Trial Agents

- **PRD:** Revenue Alert — Critical (MRR)
- **Status:** ready
- **Priority:** 1
- **Description:** Create email_verification_tokens table, configure Resend, send verification emails to 386 unverified agents. Unlock access to trial account for 88% of user base.
- **Workflow:** Dev > QC
...
### uc-onboarding-aha-moment-auto — Auto-Trigger Onboarding Wizard & Implement Aha Moment Demo

- **PRD:** Revenue Alert — Critical (MRR)
- **Status:** ready
- **Priority:** 1
- **Description:** Auto-launch onboarding post-email verification. Integrate lead simulator as final step. Add 3 sample leads to empty dashboard. Track onboarding completion telemetry. Target: 20%+ of verified agents see aha moment by Day 49.
- **Workflow:** Dev > QC

### uc-trial-activation-email-sequence — First-Login Welcome Email Sequence
...
### UC-REVENUE-RECOVERY-IMMEDIATE-D47 — Revenue Recovery — Immediate Priority Actions (Day 47)

- **PRD:** Revenue Recovery — Immediate Priority Actions (Day 47)
- **Status:** in_progress
- **Priority:** 1
- **Description:** P0: Pilot recruitment approval, P1: Stripe keys in Vercel, P2: Trial-to-paid conversion funnel
- **Acceptance Criteria:**
  - P0: Stojan approval, 3+ agents invited, 2+ verified | P1: Stripe keys set, checkout returns 200 | P2: Sample leads, wizard auto-trigger, email sequence, first paid customer
- **Workflow:** PM > Orchestrator > Marketing > Dev > QC
...
- **Status:** ready
- **Priority:** 2
- **Description:** Show trial countdown on dashboard. <3 days: bold red warning with upgrade CTA.
- **Acceptance Criteria:**
  - Countdown badge visible. <3 days triggers red styling. Upgrade button links to pricing.
- **Workflow:** Dev > QC

### uc-trial-email-sequence-002 — Automated Trial-to-Paid Conversion Emails

- **PRD:** Revenue Recovery — Critical Path to $20K MRR
- **Status:** ready
- **Priority:** 2
- **Description:** Send emails Day 3, Day 7, Day 12 of trial with upgrade links. Drive trial → paid conversions.
- **Acceptance Criteria:**
  - Emails send on correct days. Each has upgrade link. Tracking & unsubscribe working.
- **Workflow:** Dev > QC

### uc-action-4-funnel-analytics — Action 4: Measure Pilot Conversion Funnel

- **PRD:** Revenue Alert System — Loop Prevention & Revenue Gap Analysis
- **Status:** not_started
- **Priority:** 2
- **Description:** Build conversion funnel dashboard, track signup→paid conversion, alert on stuck pilots
- **Workflow:** Analytics > PM

### uc-pricing-conversion-003 — Pricing Page Trial User Optimization

- **PRD:** Revenue Recovery — Critical Path to $20K MRR
- **Status:** ready
- **Priority:** 3
- **Description:** Highlight Pro plan for trial users. Show annual discount. Update CTA text.
- **Acceptance Criteria:**
  - ?trial=true param highlights Pro. Annual discount shown. CTA is "Continue as Pro".
- **Workflow:** Design > Dev > QC
...
### feat-trial-expiry-conversion-drip — Trial Expiry Conversion Drip — Automated Email + In-App Upgrade Nudge

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** When a trial agent is 7 days from expiry, automatically send a personalized Resend email showing their AI activity stats (leads responded, time saved). Include a clear Upgrade to Pro CTA with one-click Stripe checkout link. At Day 12 send a second email. At expiry send a final email with a 20% first-month discount offer. Simultaneously display a persistent in-dashboard banner showing trial days remaining with upgrade CTA. Acceptance Criteria: (1) trial_ends_at - 7 days triggers Day 7 email via Resend; (2) trial_ends_at - 2 days triggers Day 12 email; (3) trial expiry triggers Day 14 email with discount; (4) dashboard shows countdown banner for users with <14 days remaining; (5) banner links to Stripe checkout for Pro plan; (6) emails include real agent activity data from database.
- **Workflow:** PM > Dev > QC

### feat-guided-fub-onboarding-wizard — Guided FUB Onboarding Wizard — Connect CRM in <5 Minutes

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** Interactive step-by-step wizard in /setup that walks a new agent through connecting their Follow Up Boss CRM. Steps: (1) Enter FUB API key with link to FUB Settings > API; (2) System automatically registers LeadFlow webhook in FUB; (3) Send a test lead to verify connection; (4) Show the AI response that would have been sent. Progress is saved so agents can resume. Completion unlocks the aha moment simulator. Acceptance Criteria: (1) Agent can enter FUB API key; (2) System calls FUB API to register webhook automatically; (3) Webhook registration success/failure shown immediately; (4) Test lead triggers simulated AI response display; (5) Completion status stored in real_estate_agents.fub_connected=true; (6) Agents without FUB connected see a persistent setup nudge on dashboard homepage.
- **Workflow:** PM > Dev > QC

### feat-weekly-roi-activity-email — Weekly ROI Activity Email — Prove Value Before Trial Expires

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** Every Monday morning, send each active trial and paid agent a personalized email via Resend showing: leads auto-responded in past 7 days, appointments booked, average response time vs industry benchmark (5 minutes vs 35 minutes), and estimated commission at risk if they had missed those leads. For trial agents, include days remaining and upgrade CTA. For paid agents, include a referral link. Acceptance Criteria: (1) Cron job runs every Monday 9am agent local time (or Monday 9am ET); (2) Email includes real data from sms_messages and bookings tables; (3) Trial agents get upgrade CTA with Stripe checkout link; (4) Email open rates tracked via Resend; (5) Unsubscribe link included; (6) Email not sent if agent has zero activity (prevents empty/useless emails).
- **Workflow:** PM > Dev > QC
...
### feat-trial-to-paid-conversion-sprint — Trial-to-Paid Conversion Sprint — Fix Stripe + Email Sequence for 367 Trial Users

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** CRITICAL REVENUE GAP: 367 real estate agents are on trial plans with $0 MRR. Two reasons none have converted: (1) Stripe is not configured in Vercel production — billing endpoints return 503, making it technically impossible to pay; (2) No email sequence exists to nudge trial users toward upgrade.

Acceptance Criteria:
1. STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET are set in Vercel production
2. /api/billing/create-checkout-session returns 200 with a valid Stripe checkout URL
3. Test upgrade flow completes end-to-end in production
4. Automated email sent at trial day 7, 12, and 14 with direct upgrade link
5. Email contains ROI message: X leads responded this week. Upgrade to keep it running.
6. Stripe webhook correctly updates plan_tier from trial to starter/pro
7. Post-payment confirmation email sent via Resend
8. At least 1 trial user converts to paid within 7 days of feature launch
- **Acceptance Criteria:**
  - STRIPE_SECRET_KEY set in Vercel production
  - STRIPE_WEBHOOK_SECRET set in Vercel production
  - Billing checkout endpoint returns valid Stripe URL in production
  - Trial day 7 email sent with upgrade link
  - Trial day 12 urgency email sent
  - Trial day 14 expiry email sent with special offer
  - Stripe webhook updates plan_tier correctly
  - At least 1 conversion within 7 days of launch
- **Workflow:** PM > Dev > QC

### feat-pilot-activation-white-glove — Pilot Activation White-Glove Onboarding — Convert 11 Pilots to Active and Paid

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** There are 11 agents on the pilot plan with $0 MRR. These are the warmest leads — already interested, never activated. White-glove activation means:

1. Stojan personally emails each of the 11 pilots with a 30-min onboarding call offer
2. During the call: connect FUB API key, configure webhook, trigger a test lead response
3. The agent watches their AI respond to a real lead in under 30 seconds — this IS the aha moment
4. After the call: send a 5-day value summary email showing leads responded and time saved
5. At day 14: offer a discounted Pro plan ($99/first month) to convert pilot to paid

Acceptance Criteria:
1. Admin tool shows list of all 11 pilots with contact info and activation status
2. Email template created for initial outreach
3. Onboarding call script created
4. Activation checklist: FUB connected, test lead fired, aha moment confirmed
5. Follow-up email sequence triggered automatically post-call
6. Conversion offer email at day 14 with Stripe payment link
7. Goal: 5+ of 11 pilots become paying customers ($745+ MRR immediately)
- **Acceptance Criteria:**
  - Admin view shows all 11 pilots with contact info and FUB activation status
  - Outreach email template written and ready
  - Onboarding call script/deck created
  - FUB activation confirmed for at least 5 pilots
  - At least 1 pilot witnesses AI response to live lead during call
  - Day-14 conversion email with Stripe link sent to all activated pilots
  - At least 3 pilots convert to paid ($447+ MRR)
- **Workflow:** PM > Dev > QC
...
### feat-activation-roi-proof-email — Weekly AI Activity Report — Prove ROI to Every Trial User Before They Churn

- **PRD:** -
- **Status:** not_started
- **Priority:** 0
- **Description:** The biggest reason trial users do not convert to paid: they never see concrete proof that the AI worked. Send every trial user a weekly email showing exactly what LeadFlow did for them:

- Your AI responded to 12 leads this week
- Average response time: 28 seconds
- 3 leads booked appointments
- Estimated time saved: 4.2 hours
- Industry benchmark: 78% of deals go to first responder — you are winning that race

This transforms the abstract value proposition into personalized, undeniable proof. The email ends with: Keep this going for $149/month — that is less than one commission cost.

Acceptance Criteria:
1. Weekly cron job runs every Sunday 8am, queries each trial agent activity for the past 7 days
2. Email template renders personalized metrics: leads_responded, avg_response_time_seconds, appointments_booked, time_saved_hours
3. If zero activity: email sends a different message — Your AI is ready and waiting. Connect FUB to start.
4. Upgrade CTA at bottom with direct Stripe checkout link pre-populated with agent email
5. Unsubscribe link included for TCPA compliance
6. Tracked: open rate, click rate, conversion rate per cohort
7. A/B test: Version A (metrics only) vs Version B (metrics plus social proof quote)
- **Acceptance Criteria:**
  - Weekly cron sends emails to all trial users every Sunday 8am
  - Email shows personalized: leads_responded, avg_response_time, appointments_booked
  - Zero-activity variant email triggers FUB connection CTA
  - Direct Stripe checkout link in upgrade CTA
  - Unsubscribe mechanism implemented
  - Email open/click rates tracked in analytics table
  - A/B test variant split implemented
  - At least 5% trial-to-paid conversion rate within 30 days
- **Workflow:** PM > Dev > QC

### UC-ONBOARDING-COMPLETION-BASELINE — Onboarding Completion Rate Baseline & Drop-Off Analysis
...
- **PRD:** Launch Acquisition Campaign — Signups 10+/Day Minimum
- **Status:** not_started
- **Priority:** 1
- **Description:** Activate 4 paid and organic acquisition channels (Referral, FUB Marketplace, Reddit Ads, Facebook Ads). Target: 10+ signups/day, CAC <$100, conversion >2%.
- **Acceptance Criteria:**
  - Referral program: Links, dashboard widget, and tracking fully operational
  - FUB marketplace: App submitted and approved/live
  - Reddit campaigns: 3 variations live with budget allocated ($1,800)
  - Facebook campaigns: 3 variations live with lead form working ($2,400)
  - GA4 custom events: signup_source, trial_completion, purchase events firing correctly
  - lead_sources table: Created with full tracking (source, campaign, utm_*, agent_id, conversion_at)
  - Daily acquisition dashboard: Auto-generated with signups/CAC/conversion rates
  - Minimum daily signups: 10+ signups/day by Day 49 (end of campaign launch phase)
  - CAC target: Blended CAC <$100 across paid channels
  - Conversion rate: >2% from signup to trial activation
  - Zero-CAC percentage: >50% of new signups from referral/FUB by Day 45
- **Workflow:** PM > Marketing > Dev > QC

### UC-TRIAL-EMAIL-SEQUENCE-V2 — Trial-to-Paid Email Sequence
...
### UC-LANDING-PAGE-ANALYTICS-V2 — Landing Page Analytics & Attribution Tracking
...
### fix-hardcoded-agentid-use-auth-session — Fix hardcoded agentId — read real agent ID from auth session

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** The dashboard currently uses a hardcoded test-agent-id in multiple components (LeadSatisfactionCard, analytics queries, etc.). This causes all authenticated agents to see data for the test agent instead of their own. The fix is to read the authenticated agent ID from the server-side session/cookie and pass it to all dashboard components and API calls.
- **Acceptance Criteria:**
  - GET /api/auth/me returns { agentId, email } for the authenticated session — verified with valid JWT cookie
  - Dashboard page server component reads agentId from NextAuth session (getServerSession) — no hardcoded value
  - All dashboard API calls include the real agentId derived from the session
  - LeadSatisfactionCard receives agentId as prop from the parent page, not from a hardcoded constant
  - Unauthenticated requests to /dashboard return 401 or redirect to /login
  - Two test agents signed in simultaneously see their own distinct data — cross-contamination impossible
  - No occurrence of hardcoded agentId strings (e.g. "test-agent-id", "hardcoded") remains in frontend components
- **Workflow:** Dev > QC
...
### fix-distribution-collector-task-loop — Fix Distribution Collector — Prevent Repeated Task Creation (Loop Bug)

- **PRD:** Fix Distribution Collector Task Loop
- **Status:** not_started
- **Priority:** 3
- **Description:** distribution-collector.js has no deduplication: creates identical tasks on every heartbeat run when an issue persists. Fix by adding dedup check, UC completion check, 24h cooldown, and consistent DB connection.
- **Acceptance Criteria:**
  - {"checks":[{"id":"no-local-postgrest","description":"No LOCAL_POSTGREST_URL in distribution-collector.js","machine_verifiable":true},{"id":"dedup-active-tasks","description":"createDistributionTasks checks for existing active tasks before creating","machine_verifiable":true},{"id":"uc-completion-check","description":"Issues for complete UCs are skipped","machine_verifiable":true},{"id":"cooldown-24h","description":"Same issue_type not re-created within 24h","machine_verifiable":true}]}
- **Workflow:** Dev > QC
...
### fix-smoke-auth-signup-login-loop — Fix Auth Smoke Test Loop (signup_login_flow)

- **PRD:** Fix Auth Smoke Loop V6 — Git-Conflict-Aware + Loop Detector Cooldown
- **Status:** in_progress
- **Priority:** 1
- **Description:** The smoke test for auth-signup-login-flow uses a non-existent check_type causing infinite task creation. Replace with http_200 check and fix genome loop-detector cooldown.
- **Acceptance Criteria:**
  - 1. project.config.json smoke_tests has NO check_type signup_login_flow entry
2. auth-signup-login-flow entry uses check_type http_200 with url key
3. JSON remains valid after change
4. Change committed and pushed
5. No new Smoke: Auth loop tasks in next 2 heartbeats
6. genome task-store.js loop detector has 24h cooldown for completed PM loop tasks
- **Workflow:** PM > Dev > QC
...
### fix-admin-simulator-unprotected-http-200-to-unauthenti — Admin simulator unprotected — HTTP 200 to unauthenticated requests

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Admin simulator unprotected — HTTP 200 to unauthenticated requests
**Type:** security
**Severity:** critical
**Source:** Product review 1792d355-92db-434a-8327-bd1b265a7b81

**Details:** Middleware PROTECTED_ROUTES missing /admin/*. Any public user can access /admin/simulator. Known UC fix-admin-simulator-unprotected-server-side-http-200-t with status not_started.

**Suggested fix:** Add '/admin' to PROTECTED_ROUTES in middleware.ts. Demo tokens should bypass auth for simulator page only.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-public-api-url-missing-rest-v1-all-db-operati — NEXT_PUBLIC_API_URL missing /rest/v1 — all DB operations fail in production

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## NEXT_PUBLIC_API_URL missing /rest/v1 — all DB operations fail in production
**Type:** bug
**Severity:** critical
**Source:** Product review c7111a43-e187-426d-b30b-ac0c4608d282

**Details:** The custom PostgREST client (lib/db.ts) constructs URLs as {NEXT_PUBLIC_API_URL}/{table}. With NEXT_PUBLIC_API_URL=https://fptrokacdwzlmflyczdz.supabase.co, the URL becomes https://fptrokacdwzlmflyczdz.supabase.co/pilot_signups which returns 404 "requested path is invalid". The correct Supabase REST URL requires /rest/v1: https://fptrokacdwzlmflyczdz.supabase.co/rest/v1. This causes the DB upsert to fail, returning {"success":false,"error":"Failed to save. Please try again."}. The previous review (task 6a6e7955, March 17) reported pass — it is unclear how it passed then. Either the Vercel env var was correct then and has since changed, or the test was not done against the live Vercel endpoint.

**Suggested fix:** In Vercel env vars for leadflow-ai-five: change NEXT_PUBLIC_API_URL from https://fptrokacdwzlmflyczdz.supabase.co to https://fptrokacdwzlmflyczdz.supabase.co/rest/v1. Also update product/lead-response/dashboard/.env.production and .env to use /rest/v1 suffix. Redeploy.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-zero-real-pilot-recruitment-at-day-43-90 — Zero real pilot recruitment at Day 43/90

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Zero real pilot recruitment at Day 43/90
**Type:** bug
**Severity:** critical
**Source:** Product review 5a75e349-104c-4b01-9298-03f69b05f697

**Details:** Both real_estate_agents accounts (madzunkov@gmail.com, madzunkov@hotmail.com) are the product owner. Pilot recruitment approval has been WAITING since Feb 25 (Day 1). Zero real estate agents recruited. The complete technical funnel exists but has no real users.

**Suggested fix:** Immediate human action: Stojan direct outreach to network real estate agents this week.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-stripe-not-configured-in-vercel-paid-conversion-re — Stripe not configured in Vercel — paid conversion returns 503

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Stripe not configured in Vercel — paid conversion returns 503
**Type:** bug
**Severity:** critical
**Source:** Product review 5a75e349-104c-4b01-9298-03f69b05f697

**Details:** STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET missing from Vercel production. Action items WAITING since March 23. Subscriptions table empty. Any agent trying to upgrade gets a 503 error.

**Suggested fix:** Add STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET to Vercel Settings > Environment Variables.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-no-trial-to-paid-conversion-sequence-trials-expire — No trial-to-paid conversion sequence — trials expire silently

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## No trial-to-paid conversion sequence — trials expire silently
**Type:** feature_gap
**Severity:** critical
**Source:** Product review 5a75e349-104c-4b01-9298-03f69b05f697

**Details:** feat-trial-expiry-email-sequence is not_started. feat-in-dashboard-trial-countdown-upgrade-prompt is not_started. madzunkov@gmail.com trial expires April 10 with no conversion attempt. No drip emails, no countdown banner.

**Suggested fix:** Build: (1) in-dashboard trial countdown banner + upgrade CTA; (2) Resend drip: Day 7, Day 12, Day 14 expiry emails.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-stripe-billing-completely-broken-placeholder-price — Stripe billing completely broken — placeholder price IDs and missing checkout API

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Stripe billing completely broken — placeholder price IDs and missing checkout API
**Type:** bug
**Severity:** critical
**Source:** Product review 7112a09a-0ca5-4f9f-b91a-2d196f17c525

**Details:** Vercel env has placeholder Stripe price IDs (price_starter_49, price_pro_149, price_team_399). /api/stripe/create-checkout-session returns 404. No paid subscription can be created.

**Suggested fix:** Create real Stripe products, get price_1XXXXX IDs, update Vercel env vars, deploy checkout API route.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-distribution-collector-js-still-queries-http-local — distribution-collector.js still queries http://localhost:8787 (PostgREST) — returns Not Found for all table queries

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## distribution-collector.js still queries http://localhost:8787 (PostgREST) — returns Not Found for all table queries
**Type:** bug
**Severity:** critical
**Source:** Product review 4e564f2b-9c03-4f51-831f-7afcaf1f9729

**Details:** Line 28 falls back to localhost:8787. LOCAL_POSTGREST_URL not set in genome .env. Server returns Not Found for /distribution_channels. Health check gets 0 rows. distribution_channels IS seeded in cloud Supabase but unreachable. Wave 4 Fix D NOT applied.

**Suggested fix:** Change line 28: const supabaseUrl = process.env.SUPABASE_URL
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-stripe-webhook-handler-uses-agent-id-but-subscript — Stripe webhook handler uses agent_id but subscriptions table has user_id column

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Stripe webhook handler uses agent_id but subscriptions table has user_id column
**Type:** bug
**Severity:** critical
**Source:** Product review 619660b4-ceb7-40e7-937b-57886f29ce2c

**Details:** In product/lead-response/dashboard/app/api/webhooks/stripe/route.ts, all subscription insert/update operations use agent_id (at least 5 locations). The subscriptions table created by migration 003_stripe_subscriptions.sql uses user_id. Every Stripe webhook attempting to persist subscription data will fail with column-not-found errors.

**Suggested fix:** Replace agent_id with user_id in all subscription inserts in route.ts. Also update metadata reads from metadata?.agent_id to metadata?.user_id (or support both for backward compat with existing Stripe subs).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-stripe-not-configured-in-vercel-367-trial-users-ca — Stripe not configured in Vercel — 367 trial users cannot upgrade to paid

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Stripe not configured in Vercel — 367 trial users cannot upgrade to paid
**Type:** blocking
**Severity:** critical
**Source:** Product review 7de693c5-6683-47fb-b69e-dc3e703e920d

**Details:** All billing endpoints return 503. STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET are missing from Vercel production environment. This makes revenue generation technically impossible — even if users want to pay, they cannot.

**Suggested fix:** Add STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET to Vercel environment variables immediately. Verify with a test checkout in production.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-367-trial-accounts-0-mrr-no-trial-to-paid-conversi — 367 trial accounts, $0 MRR — no trial-to-paid conversion mechanism exists

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## 367 trial accounts, $0 MRR — no trial-to-paid conversion mechanism exists
**Type:** gap
**Severity:** critical
**Source:** Product review 7de693c5-6683-47fb-b69e-dc3e703e920d

**Details:** There are 367 agents on trial plans and 11 on pilot plans — all with $0 MRR. No email sequence, in-app banner, or conversion nudge exists. The trial window is expiring with no action. Even with Stripe fixed, users will not self-upgrade without a trigger.

**Suggested fix:** Implement trial expiry email sequence (day 7, 12, 14) with ROI data and direct Stripe checkout links.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-11-pilots-with-no-aha-moment-warmest-leads-going-c — 11 pilots with no aha moment — warmest leads going cold

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## 11 pilots with no aha moment — warmest leads going cold
**Type:** gap
**Severity:** critical
**Source:** Product review 7de693c5-6683-47fb-b69e-dc3e703e920d

**Details:** 11 agents specifically opted into the pilot program but have $0 MRR and likely have not connected FUB. These are the most motivated potential customers, and they are being left without activation support. This is the highest-probability path to first revenue.

**Suggested fix:** Stojan personally reaches out to all 11 pilots within 48 hours to schedule activation calls. Goal: 5 activated, 3 converted to paid.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-sequences-not-paused-when-lead-responds-via-sms — Sequences NOT paused when lead responds via SMS

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Sequences NOT paused when lead responds via SMS
**Type:** bug
**Severity:** critical
**Source:** Product review c25afcd0-5e0d-4a7f-a19d-53c88b8f2f54

**Details:** The Twilio webhook handler (/api/webhook/twilio/route.ts) processes inbound SMS from leads but has zero calls to pauseAllSequences() or pauseSequence(). This means active follow-up sequences continue sending even after a lead replies, directly violating acceptance criterion: Sequence stops if lead responds. The sequence library (lib/sequences.ts) has pauseAllSequences() available but it is never called from the inbound SMS path.

**Suggested fix:** In /api/webhook/twilio/route.ts, after saving the inbound message, call pauseAllSequences(lead.id) from lib/sequences before generating the AI response.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-db-migration-not-run-agents-table-missing-utm-colu — DB migration not run — agents table missing UTM columns

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## DB migration not run — agents table missing UTM columns
**Type:** bug
**Severity:** critical
**Source:** Product review c25c35e1-8803-4720-a29a-dc1cab8a9b7c

**Details:** The agents table does not have utm_source, utm_medium, utm_campaign, utm_content, or utm_term columns. The API endpoint (api/auth/trial-signup/route.ts) attempts to write these columns on signup. No attribution data can be stored until migration runs. Run: ALTER TABLE agents ADD COLUMN IF NOT EXISTS utm_source text, ADD COLUMN IF NOT EXISTS utm_medium text, ADD COLUMN IF NOT EXISTS utm_campaign text, ADD COLUMN IF NOT EXISTS utm_content text, ADD COLUMN IF NOT EXISTS utm_term text;

**Suggested fix:** Run FR-3 migration SQL in Supabase production.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-sequences-not-paused-when-lead-responds-inbound-sm — Sequences not paused when lead responds (inbound SMS)

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Sequences not paused when lead responds (inbound SMS)
**Type:** bug
**Severity:** critical
**Source:** Product review ee4c24f6-fc06-44d9-bf30-f071aa4d3fb2

**Details:** UC-8 AC: Sequence stops if lead responds. Twilio inbound webhook does NOT call pauseAllSequences(). Follow-ups continue firing after lead reply.

**Suggested fix:** In twilio/route.ts, call pauseAllSequences(lead.id) after identifying the lead.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-sequences-not-paused-when-lead-books-appointment — Sequences not paused when lead books appointment

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Sequences not paused when lead books appointment
**Type:** bug
**Severity:** critical
**Source:** Product review ee4c24f6-fc06-44d9-bf30-f071aa4d3fb2

**Details:** UC-8 AC: Sequence stops if lead books appointment. Cal.com webhook does NOT call pauseAllSequences(). Follow-ups continue after booking.

**Suggested fix:** In calcom/route.ts, call pauseAllSequences(lead.id) on booking confirmation.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-api-endpoint-uses-non-existent-column-twilio-statu — API endpoint uses non-existent column twilio_status

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## API endpoint uses non-existent column twilio_status
**Type:** bug
**Severity:** critical
**Source:** Product review 5b8b0c51-b037-4845-b592-2fdc55f77b28

**Details:** The GET /api/analytics/sms-stats route filters deliveries using m.twilio_status === "delivered", but the sms_messages table column is named "status", not "twilio_status". This causes a Postgres 42703 error (column does not exist) and makes the API endpoint fail with 500.

**Suggested fix:** Change product/lead-response/dashboard/app/api/analytics/sms-stats/route.ts line 94 from m.twilio_status to m.status
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-dashboard-not-deployed-vercel-rootdirector — Next.js dashboard not deployed — Vercel rootDirectory misconfigured

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js dashboard not deployed — Vercel rootDirectory misconfigured
**Type:** deployment
**Severity:** critical
**Source:** Product review 12d379e0-7bde-4260-9bbd-5c83e7edf0f9

**Details:** Vercel project prj_p9ZX952UhE1cl1PYZAgVW53FqVm9 has rootDirectory=null in .vercel/project.json. Vercel deploys from repo root (Express.js FUB webhook) instead of product/lead-response/dashboard/. leadflow-ai-five.vercel.app returns FUB webhook API JSON for all paths. All customer-facing routes (login, signup, dashboard, API) return 404. This blocks the entire product, not just this feature. Latest commit 48acd2dc attempted a redeploy trigger but rootDirectory fix requires a Vercel UI change, not a file commit.

**Suggested fix:** In Vercel project settings (prj_p9ZX952UhE1cl1PYZAgVW53FqVm9), set Root Directory to "product/lead-response/dashboard" via the Vercel dashboard UI, then redeploy.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-live-site-serves-api-json-instead-of-next-js-dashb — Live site serves API JSON instead of Next.js dashboard — pricing section invisible to users

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Live site serves API JSON instead of Next.js dashboard — pricing section invisible to users
**Type:** deployment
**Severity:** critical
**Source:** Product review 2468e440-32eb-43ed-9ece-9d5a46b7ba18

**Details:** leadflow-ai-five.vercel.app returns {"status":"ok","service":"FUB AI Lead Response System"...} (151 bytes JSON). The Vercel project "leadflow-ai" has rootDirectory=null in .vercel/project.json, meaning it deploys the repo root server.js instead of product/lead-response/dashboard/. The most recent git commit message "trigger: redeploy dashboard with correct root directory" suggests this was attempted but did not take effect on the live deployment. All pricing code is correct in source but unreachable by real users.

**Suggested fix:** Set rootDirectory to "product/lead-response/dashboard" in Vercel project settings UI (not in .vercel/project.json which is ignored for this setting), then redeploy with https://fub-inbound-webhook-qefyengq7-stojans-projects-7db98187.vercel.app from that directory.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-leadmagnetsection-not-integrated-into-landing-page — LeadMagnetSection not integrated into landing page

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## LeadMagnetSection not integrated into landing page
**Type:** bug
**Severity:** critical
**Source:** Product review 0ef1490d-889d-4050-8d61-4e113dc89fd0

**Details:** Component exists at components/LeadMagnetSection.tsx with full implementation (form, GA4 tracking, UTM capture) but NOT imported or rendered in app/page.tsx. Zero visitor-facing presence.

**Suggested fix:** Import LeadMagnetSection in app/page.tsx between testimonials and pricing sections.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-api-lead-capture-endpoint-returns-404-in-productio — /api/lead-capture endpoint returns 404 in production

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## /api/lead-capture endpoint returns 404 in production
**Type:** bug
**Severity:** critical
**Source:** Product review 0ef1490d-889d-4050-8d61-4e113dc89fd0

**Details:** POST to https://leadflow-ai-five.vercel.app/api/lead-capture returns HTML Cannot POST error. Route.ts exists in codebase but Vercel deployment does not include it.

**Suggested fix:** Commit route.ts and trigger new Vercel deployment.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-dashboard-not-deployed-admin-simulator-and — Next.js dashboard not deployed — /admin/simulator and all Next.js routes return 404

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js dashboard not deployed — /admin/simulator and all Next.js routes return 404
**Type:** bug
**Severity:** critical
**Source:** Product review 71421dc0-aa38-4ab7-8e0e-6863b328b3c9

**Details:** leadflow-ai-five.vercel.app serves the Express webhook backend (server.js) instead of the Next.js customer dashboard. Homepage returns {"status":"ok","service":"FUB AI Lead Response System"}. All Next.js routes return HTTP 404 with x-powered-by: Express. Next.js source code is complete in product/lead-response/dashboard/ including /admin/simulator. A vercel --prod attempt during this review returned an unexpected Vercel error.

**Suggested fix:** Investigate Vercel build error (check vercel.com dashboard), verify env vars, then redeploy from product/lead-response/dashboard/
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-all-3-simulator-api-endpoints-return-404-e2e-tests — All 3 simulator API endpoints return 404 — E2E tests fail 8/11

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## All 3 simulator API endpoints return 404 — E2E tests fail 8/11
**Type:** bug
**Severity:** critical
**Source:** Product review 71421dc0-aa38-4ab7-8e0e-6863b328b3c9

**Details:** POST /api/admin/simulate-lead → 404, GET /api/admin/conversations → 404, POST /api/admin/demo-link → 404. 8 of 11 E2E tests fail. Root cause is deployment issue — API routes exist in code but not deployed.

**Suggested fix:** Deploy Next.js dashboard. Re-run tests/feat-lead-experience-simulator.test.js after deployment.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-leadflow-ai-five-vercel-app-serving-fub-webhook-ap — leadflow-ai-five.vercel.app serving FUB Webhook API — customer dashboard not deployed

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## leadflow-ai-five.vercel.app serving FUB Webhook API — customer dashboard not deployed
**Type:** bug
**Severity:** critical
**Source:** Product review 634f4e59-2c64-42aa-b829-67a2a58a1af5

**Details:** GET https://leadflow-ai-five.vercel.app/ returns {status:ok, service:FUB AI Lead Response System}. POST /api/lead-capture returns 404. The Next.js dashboard app (which contains the fixed lead-capture route) is not deployed at this URL. project.config.json lists leadflow-ai-five.vercel.app as the customer-dashboard product but it is serving the webhook app instead.

**Suggested fix:** Re-deploy the Next.js dashboard: cd product/lead-response/dashboard && vercel --prod --yes. Verify by checking root URL returns HTML, not JSON.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-demo-page-not-deployed-to-production — Demo page not deployed to production

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Demo page not deployed to production
**Type:** critical
**Severity:** critical
**Source:** Product review 328e8f0a-3af4-4599-bd4e-ad490235c00e

**Details:** The /demo route works on localhost but returns 404 on Vercel production. Build is in error state.

**Suggested fix:** Fix Vercel production deployment
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-trial-signup-bypasses-email-verification-gate-enti — Trial signup bypasses email verification gate entirely

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Trial signup bypasses email verification gate entirely
**Type:** bug
**Severity:** critical
**Source:** Product review cfaeab07-6512-4e58-b97e-18aa5aaed26a

**Details:** In /api/auth/trial-signup/route.ts line 135, the agent is created with email_verified: true and no verification email is sent. The comment says "No email verification gate for trial (per PRD)" but the PRD explicitly states all signups must verify email before login. The core feature requirement is not enforced for trial users — the most common signup path.

**Suggested fix:** Change trial-signup to set email_verified: false, create a verification token, send the verification email, and redirect to /check-your-inbox?email=<email>.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-customer-dashboard-not-accessible-at-any-p — Next.js customer dashboard not accessible at any public URL

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js customer dashboard not accessible at any public URL
**Type:** bug
**Severity:** critical
**Source:** Product review d32923eb-7d95-4bc4-b2f1-5fb1df5c24bb

**Details:** Dashboard .vercel/project.json → projectName: leadflow-ai. But leadflow-ai.vercel.app is a Vite+React stub, and leadflow-ai-five.vercel.app is the FUB webhook.

**Suggested fix:** cd product/lead-response/dashboard && vercel deploy --prod. Update project.config.json and CLAUDE.md.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-customer-dashboard-not-deployed-billing-ro — Next.js customer dashboard NOT deployed — billing routes return 404

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js customer dashboard NOT deployed — billing routes return 404
**Type:** bug
**Severity:** critical
**Source:** Product review 048c9be5-a0a4-4515-b06a-bf957e80aabb

**Details:** The Vercel project leadflow-ai at leadflow-ai.vercel.app hosts a Vite+React app (title: Vite + React + TS), not the Next.js customer dashboard. All billing API routes (/api/billing/create-checkout, /api/webhooks/stripe) return 404. The Stripe env var fix cannot take effect without a proper deployment.

**Suggested fix:** Deploy from product/lead-response/dashboard/ to Vercel project leadflow-ai: cd product/lead-response/dashboard && vercel --prod --yes
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-stripe-secret-key-and-stripe-webhook-secret-confir — STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET confirmed missing from Vercel production

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET confirmed missing from Vercel production
**Type:** config
**Severity:** critical
**Source:** Product review 048c9be5-a0a4-4515-b06a-bf957e80aabb

**Details:** Code in /app/api/billing/create-checkout/route.ts and /api/webhooks/stripe/route.ts returns Stripe not configured (503) when vars absent. Routes are currently 404 (not deployed), so the 503 cannot be triggered. After deployment, these vars must be set before billing works.

**Suggested fix:** Vercel Dashboard → leadflow-ai → Settings → Env Vars → Add STRIPE_SECRET_KEY + STRIPE_WEBHOOK_SECRET (Production) → Redeploy
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-dashboard-not-deployed-at-leadflow-ai-five — Next.js dashboard not deployed at leadflow-ai-five.vercel.app

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js dashboard not deployed at leadflow-ai-five.vercel.app
**Type:** deployment
**Severity:** critical
**Source:** Product review ad10d236-eec6-4ce8-9f6e-59b0325fba3c

**Details:** leadflow-ai-five.vercel.app serves the Express FUB webhook server (returns {status:ok, service:FUB AI Lead Response System}), not the Next.js dashboard app. All Next.js API routes return 404 including /api/auth/me, /api/auth/trial-status, /signup/trial, /signup/pilot. The auth token fix code is implemented correctly in the codebase but end-to-end validation is blocked because the dashboard is not deployed.

**Suggested fix:** Deploy the Next.js dashboard from product/lead-response/dashboard/ to a dedicated Vercel project. Check Vercel project settings — root directory must be set to product/lead-response/dashboard.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-js-dashboard-not-deployed-all-admin-invite-ui — Next.js dashboard not deployed — all admin invite UI routes return 404

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Next.js dashboard not deployed — all admin invite UI routes return 404
**Type:** deployment
**Severity:** critical
**Source:** Product review dc013919-4ace-45ff-9f9f-be3e94a524e2

**Details:** leadflow-ai-five.vercel.app still serves the Express FUB webhook server. GET /admin/invite returns 404. This is the 4th consecutive review blocked by this deployment issue. Next.js dashboard code is complete and correct — not deployed.

**Suggested fix:** Deploy Next.js dashboard from product/lead-response/dashboard/ to Vercel. Root directory must be set to product/lead-response/dashboard/ in Vercel project settings.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-server-side-stripe-price-env-vars-missing-only-nex — Server-side STRIPE_PRICE_* env vars missing — only NEXT_PUBLIC_ variants exist

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Server-side STRIPE_PRICE_* env vars missing — only NEXT_PUBLIC_ variants exist
**Type:** bug
**Severity:** critical
**Source:** Product review 9aecd031-8508-4601-94a6-d5790f400a2f

**Details:** Checkout route reads STRIPE_PRICE_STARTER_MONTHLY etc. Vercel only has NEXT_PUBLIC_STRIPE_PRICE_* (not readable server-side). All checkout calls return 503 PRICE_NOT_CONFIGURED for all tiers.

**Suggested fix:** Add STRIPE_PRICE_STARTER_MONTHLY, STRIPE_PRICE_STARTER_ANNUAL, STRIPE_PRICE_PRO_MONTHLY, STRIPE_PRICE_PRO_ANNUAL, STRIPE_PRICE_TEAM_MONTHLY, STRIPE_PRICE_TEAM_ANNUAL with real price_... IDs.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-accept-invite-does-not-create-auth-session-agents- — accept-invite does not create auth session — agents cannot reach onboarding after accepting

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## accept-invite does not create auth session — agents cannot reach onboarding after accepting
**Type:** bug
**Severity:** critical
**Source:** Product review dc013919-4ace-45ff-9f9f-be3e94a524e2

**Details:** POST /api/auth/accept-invite validates token and updates agent status correctly, but step 6 (Create auth session) has a comment only — NO JWT, NO cookie is set. Client redirects to /dashboard/onboarding without authentication. Auth guard redirects agent to /login. password_hash is set to the string "invited" during creation, so agent has no valid credentials to log in with. Complete end-to-end flow is broken: invite accepted → /dashboard/onboarding → /login → stuck. AC-6 fails.

**Suggested fix:** Generate JWT auth token and set HTTP-only cookie in accept-invite route (same pattern as pilot-signup route). Consider also clearing the placeholder password_hash and guiding agent to set a password from settings.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-loop-handler-distribution-dedup — Fix Loop Detection & Distribution Collector Dedup

- **PRD:** Fix Distribution Loop — Wave 5 Emergency Escalation
- **Status:** not_started
- **Priority:** 1
- **Description:** Apply migration 006 to local PG, fix task-store.js loop detector dedup (24h cooldown), and fix distribution-collector.js (UC gate + createDistributionTasks cooldown). All files in ~/.openclaw/genome/. See prd-fix-loop-detector-wave5 for full spec.
- **Acceptance Criteria:**
  - UC completion gate skips distributed UCs. Cooldown prevents duplicate tasks within 30 min. Timestamp-based loop detector in place.
- **Workflow:** PM > Dev > QC

### fix-4-consecutive-production-deployment-failures-in-le — 4 consecutive production deployment failures in leadflow-ai Vercel project

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## 4 consecutive production deployment failures in leadflow-ai Vercel project
**Type:** bug
**Severity:** critical
**Source:** Product review 9aecd031-8508-4601-94a6-d5790f400a2f

**Details:** vercel ls shows last 4 production deployments with Error status. Preview builds succeed. Production billing APIs inaccessible until fixed.

**Suggested fix:** Inspect deployment logs in Vercel Dashboard, fix TypeScript build error, trigger new production deployment.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-webhook-handler-uses-agent-id-instead-of-user-id-f — Webhook handler uses agent_id instead of user_id for subscription_events inserts

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Webhook handler uses agent_id instead of user_id for subscription_events inserts
**Type:** bug
**Severity:** critical
**Source:** Product review 32fe842d-5dee-432b-a0d0-f71ff720d867

**Details:** In route.ts lines 106, 213, 231, 261, 288: all event handlers insert into subscription_events with agent_id: agentId. The DB schema (003_stripe_subscriptions.sql) defines user_id NOT agent_id. Confirmed via Supabase API: agent_id column does not exist. Every webhook event fails silently.

**Suggested fix:** Replace all agent_id: agentId with user_id: agentId in subscription_events.insert() calls in route.ts
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-api-cron-nurture-emails-endpoint-does-not-exist — /api/cron/nurture-emails endpoint does not exist

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## /api/cron/nurture-emails endpoint does not exist
**Type:** gap
**Severity:** critical
**Source:** Product review d04792da-1f6d-4cb1-a0ac-73e8f683a19b

**Details:** Decision was approved (2026-04-01) to use Vercel Cron scheduling. However, no implementation has been started. The endpoint does not exist in product/lead-response/dashboard/app/api/cron/ or app/api/cron/. No route.ts file found.

**Suggested fix:** Create product/lead-response/dashboard/app/api/cron/nurture-emails/route.ts
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-vercel-json-does-not-configure-nurture-emails-cron — vercel.json does not configure nurture-emails cron schedule

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## vercel.json does not configure nurture-emails cron schedule
**Type:** gap
**Severity:** critical
**Source:** Product review d04792da-1f6d-4cb1-a0ac-73e8f683a19b

**Details:** Decision requires daily 9 AM UTC execution. No cron entry in vercel.json. Existing crons (pilot-conversion, expire-trials, etc.) exist but nurture-emails missing.

**Suggested fix:** Add cron entry to vercel.json: { path: /api/cron/nurture-emails, schedule: "0 9 * * *" }
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-day-3-and-day-7-email-queries-not-implemented — Day 3 and Day 7 email queries not implemented

- **PRD:** -
- **Status:** not_started
- **Priority:** 1
- **Description:** ## Day 3 and Day 7 email queries not implemented
**Type:** gap
**Severity:** critical
**Source:** Product review d04792da-1f6d-4cb1-a0ac-73e8f683a19b

**Details:** Endpoint must query pilot_signups table for records created 3+ and 7+ days ago, and send emails via Resend. No logic in codebase.

**Suggested fix:** Query pilot_signups where created_at <= NOW() - INTERVAL 3 days and where day_3_sent = false, etc.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-resend-api-key-missing-from-vercel-playbook-email- — RESEND_API_KEY missing from Vercel — playbook email delivery broken

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## RESEND_API_KEY missing from Vercel — playbook email delivery broken
**Type:** configuration
**Severity:** high
**Source:** Product review 634f4e59-2c64-42aa-b829-67a2a58a1af5

**Details:** Endpoint degrades gracefully (returns success) but no playbook email is sent. Every lead capture silently drops the email delivery step. This is a known remaining item per the PRD.

**Suggested fix:** Add RESEND_API_KEY to Vercel environment variables for leadflow-ai-five project.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
- **PRD:** Fix Distribution Health Loop — Prevent Repeated Task Spawning
- **Status:** complete
- **Priority:** 2
...
- **Acceptance Criteria:**
  - No duplicate distribution tasks created within 48h window. UC completion status respected in health check. Channel existence (any status) suppresses no_landing_page issue.
- **Workflow:** PM > Marketing > Design > Dev > QC
...
### fix-conversations-viewer-broken-supabase-env-vars-miss — Conversations Viewer broken — SUPABASE env vars missing on Vercel

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Conversations Viewer broken — SUPABASE env vars missing on Vercel
**Type:** integration
**Severity:** high
**Source:** Product review 1792d355-92db-434a-8327-bd1b265a7b81

**Details:** GET /api/admin/conversations returns {error:'Failed to fetch conversations'}. NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY not in Vercel deployment. US-2 completely non-functional.

**Suggested fix:** Add NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY to Vercel environment variables.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-demo-link-generation-fails-db-env-vars-missing-on- — Demo link generation fails — DB env vars missing on Vercel

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Demo link generation fails — DB env vars missing on Vercel
**Type:** integration
**Severity:** high
**Source:** Product review 1792d355-92db-434a-8327-bd1b265a7b81

**Details:** POST /api/admin/demo-link returns {error:'Failed to create demo link'}. NEXT_PUBLIC_API_URL and API_SECRET_KEY not in Vercel env. US-3 (Demo Mode for Pilot Pitches) completely broken.

**Suggested fix:** Add NEXT_PUBLIC_API_URL and API_SECRET_KEY to Vercel. Standardize env var naming across admin routes.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-simulations-not-persisted-lead-simulations-write-f — Simulations not persisted — lead_simulations write fails in production

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Simulations not persisted — lead_simulations write fails in production
**Type:** data
**Severity:** high
**Source:** Product review 1792d355-92db-434a-8327-bd1b265a7b81

**Details:** POST /api/admin/simulate-lead returns id:null with warning:'Simulation ran but could not be saved'. lead_simulations table exists (3 records from March 9) but Vercel can't write to it.

**Suggested fix:** Same root cause as conversations failure — fix Vercel env vars.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-middleware-does-not-call-touchsession-logpageview- — Middleware does not call touchSession()/logPageView() — FR-2 and FR-3 not wired up

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Middleware does not call touchSession()/logPageView() — FR-2 and FR-3 not wired up
**Type:** bug
**Severity:** high
**Source:** Product review 0486930d-a10e-40c1-a4ab-7f41e9f02960

**Details:** middleware.ts handles auth but does NOT invoke touchSession() or logPageView(). last_active_at never updates post-login, page views never recorded.

**Suggested fix:** Add touchSession/logPageView calls in middleware.ts authenticated branch.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-guided-fub-activation-not-implemented-agents-canno — Guided FUB activation not implemented — agents cannot realize core value

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Guided FUB activation not implemented — agents cannot realize core value
**Type:** feature_gap
**Severity:** high
**Source:** Product review 5a75e349-104c-4b01-9298-03f69b05f697

**Details:** feat-guided-fub-activation is not_started. Without FUB connected, the product does nothing. Agents churn before seeing value and never convert.

**Suggested fix:** Build step-by-step FUB webhook registration wizard in /setup with exact instructions.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-no-roi-proof-loop-agents-have-no-reason-to-upgrade — No ROI proof loop — agents have no reason to upgrade

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## No ROI proof loop — agents have no reason to upgrade
**Type:** feature_gap
**Severity:** high
**Source:** Product review 5a75e349-104c-4b01-9298-03f69b05f697

**Details:** feat-activation-roi-proof-email is not_started. Without weekly summaries of lead responses, bookings, and commission impact, agents forget the product exists.

**Suggested fix:** Weekly Resend email: leads responded, bookings, response time vs manual. Include upgrade CTA for trial users.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-trialsignupform-missing-form-funnel-events-form-op — TrialSignupForm missing form funnel events (form_open, form_submit, form_success, form_error)

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## TrialSignupForm missing form funnel events (form_open, form_submit, form_success, form_error)
**Type:** bug
**Severity:** high
**Source:** Product review 70881801-b757-48a8-b417-b443a259840a

**Details:** The hero landing page uses TrialSignupForm (compact mode) as the primary conversion form. This component imports trackFormEvent but never calls it. Missing: form_open on mount, form_submit on handleSubmit entry, form_success on API success, form_error on API error. This means the most important conversion funnel data is invisible in GA4. Pilot and signup pages DO have correct instrumentation.

**Suggested fix:** Add useEffect to fire trackFormEvent("form_view", "trial_signup") on mount. Add trackFormEvent("form_submit", "trial_signup") at start of handleSubmit. Add trackFormEvent("form_success") after successful router.push. Add trackFormEvent("form_error") in catch block.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-leadsatisfactioncard-uses-hardcoded-test-agent-id- — LeadSatisfactionCard uses hardcoded test-agent-id in dashboard page

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## LeadSatisfactionCard uses hardcoded test-agent-id in dashboard page
**Type:** bug
**Severity:** high
**Source:** Product review 347399e8-ffda-4500-927c-1db2ae84bed4

**Details:** product/lead-response/dashboard/app/dashboard/page.tsx line 62 renders <LeadSatisfactionCard agentId="test-agent-id" /> instead of using the authenticated user ID. A fix was previously implemented (commit c7a63333) using LeadSatisfactionCardWrapper, but commit 59d8c44e (frictionless onboarding) regressed this by overwriting the file with the hardcoded ID. The LeadSatisfactionCardWrapper component exists and is correct but is not being used.

**Suggested fix:** Replace <LeadSatisfactionCard agentId="test-agent-id" /> with <LeadSatisfactionCardWrapper /> in dashboard/page.tsx, importing from @/components/dashboard/LeadSatisfactionCardWrapper
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-ga4-tracking-id-is-g-test-placeholder-zero-marketi — GA4 tracking ID is G-TEST-PLACEHOLDER — zero marketing analytics

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## GA4 tracking ID is G-TEST-PLACEHOLDER — zero marketing analytics
**Type:** bug
**Severity:** high
**Source:** Product review 7112a09a-0ca5-4f9f-b91a-2d196f17c525

**Details:** NEXT_PUBLIC_GA4_MEASUREMENT_ID=G-TEST-PLACEHOLDER in production. No conversion data or attribution collected. Pilot recruitment effectiveness unmeasurable.

**Suggested fix:** Create real GA4 property, update NEXT_PUBLIC_GA4_MEASUREMENT_ID in Vercel env vars.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-admin-simulator-cannot-persist-conversations-datab — Admin simulator cannot persist conversations — database save failing

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Admin simulator cannot persist conversations — database save failing
**Type:** bug
**Severity:** high
**Source:** Product review 7112a09a-0ca5-4f9f-b91a-2d196f17c525

**Details:** POST /api/admin/simulate-lead returns AI conversation with warning: Simulation ran but could not be saved. Past simulations unviewable.

**Suggested fix:** Debug Supabase insert in simulate-lead API — check table, columns, service role key (likely has trailing newline).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-multiple-production-env-vars-have-trailing-newline — Multiple production env vars have trailing newline characters

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Multiple production env vars have trailing newline characters
**Type:** bug
**Severity:** high
**Source:** Product review 7112a09a-0ca5-4f9f-b91a-2d196f17c525

**Details:** FROM_EMAIL, FUB_API_KEY, TWILIO_ACCOUNT_SID, POSTHOG_KEY, POSTHOG_HOST, API_SECRET_KEY all contain literal newline at end. Causes silent API failures and broken auth.

**Suggested fix:** Audit all Vercel env vars, remove trailing whitespace from all values, redeploy.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-main-landing-page-ctas-have-no-analytics-tracking- — Main landing page CTAs have no analytics tracking wired

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Main landing page CTAs have no analytics tracking wired
**Type:** bug
**Severity:** high
**Source:** Product review d13b5202-f2e5-49ec-a335-a72406301bf3

**Details:** app/page.tsx PricingCard components, hero CTA, nav CTA are all Link components with no onClick handlers calling trackCTAClick(). ga4.ts helper exists but is never imported in page.tsx. FR-2 is NOT satisfied for the primary landing page.

**Suggested fix:** Import trackCTAClick from ga4.ts in page.tsx, add onClick handlers to all CTAs per FR-2 table.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-scroll-depth-intersectionobservers-not-implemented — Scroll depth IntersectionObservers not implemented on main landing page

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Scroll depth IntersectionObservers not implemented on main landing page
**Type:** bug
**Severity:** high
**Source:** Product review d13b5202-f2e5-49ec-a335-a72406301bf3

**Details:** app/page.tsx has no useEffect calling attachScrollMilestoneObservers(). FR-3 scroll depth at 25%, 50%, 75% is NOT satisfied on the main landing page. The ga4.ts library has full scroll milestone infrastructure but it is never connected.

**Suggested fix:** Add scroll milestone refs and useEffect in page.tsx calling attachScrollMilestoneObservers() on features, pricing, testimonials section refs.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-next-public-ga4-measurement-id-not-set-ga4-script- — NEXT_PUBLIC_GA4_MEASUREMENT_ID not set — GA4 script disabled everywhere

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## NEXT_PUBLIC_GA4_MEASUREMENT_ID not set — GA4 script disabled everywhere
**Type:** configuration
**Severity:** high
**Source:** Product review d13b5202-f2e5-49ec-a335-a72406301bf3

**Details:** layout.tsx correctly gates GA4 script behind env var. Neither .env nor .env.production contain NEXT_PUBLIC_GA4_MEASUREMENT_ID. Zero GA4 events will fire in any environment until Stojan sets up a GA4 property and adds the ID to Vercel.

**Suggested fix:** Stojan: analytics.google.com → Create property → Copy G-XXXXXXXXXX → Vercel env vars → NEXT_PUBLIC_GA4_MEASUREMENT_ID → Redeploy.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-how-it-works-section-not-implemented-ac-2 — How It Works section not implemented (AC-2)

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## How It Works section not implemented (AC-2)
**Type:** missing_feature
**Severity:** high
**Source:** Product review 3d830f2b-23f6-4206-8e8d-d874513065c1

**Details:** The PRD (R2) requires a 3-step How It Works section positioned between the Features section and the mid-page CTA. Steps: (1) Connect Your CRM - sync FUB in 2 minutes, (2) AI Responds Instantly - SMS under 30 seconds, (3) You Close the Deal - qualified leads and calendar bookings. This section is completely absent from app/page.tsx. The page goes directly from Features+CTA to Testimonials. This was one of three main deliverables of this PRD.

**Suggested fix:** Add a section between the features section and testimonials section in app/page.tsx. Use 3-column horizontal grid (grid-cols-1 md:grid-cols-3) with alternating background. Each step: numbered badge, emoji/icon, title, 1-2 line description. Exact copy in PRD-LANDING-PAGE-CONVERSION-001.md R2.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-fub-integration-ui-exists-but-connection-flow-not- — FUB integration UI exists but connection flow not verified

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## FUB integration UI exists but connection flow not verified
**Type:** integration_readiness
**Severity:** high
**Source:** Product review b623c378-b016-4363-ba3e-a7e01808ac73

**Details:** Integrations page has FUB component, but actual OAuth flow and API key handling has not been tested end-to-end. Need to verify FUB API connection works.

**Suggested fix:** Test FUB OAuth flow end-to-end with a real FUB account
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-hero-cta-renders-blank-primary-conversion-cta-invi — Hero CTA renders blank — primary conversion CTA invisible on landing page

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Hero CTA renders blank — primary conversion CTA invisible on landing page
**Type:** bug
**Severity:** high
**Source:** Product review 7de693c5-6683-47fb-b69e-dc3e703e920d

**Details:** The hero section CTA button (Start Free Trial) has BAILOUT_TO_CLIENT_SIDE_RENDERING logged, meaning it renders as blank/empty on first load. This is the primary conversion point on the landing page — if users cannot click Start Trial, they cannot enter the funnel.

**Suggested fix:** Investigate why the hero CTA has client-side rendering issues. Convert to a simple server-rendered anchor tag or fix the Suspense boundary.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-api-connectivity-degraded-dashboard-cannot-display — API connectivity degraded — dashboard cannot display live data

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## API connectivity degraded — dashboard cannot display live data
**Type:** gap
**Severity:** high
**Source:** Product review 7de693c5-6683-47fb-b69e-dc3e703e920d

**Details:** api_connectivity check fails with HTTP 403 Invalid API key. The dashboard cannot pull live data from the backend API. Agents who do log in see a broken dashboard, which undermines confidence in the product.

**Suggested fix:** Verify NEXT_PUBLIC_API_KEY env var matches the server-side API key. Check that the Vercel frontend environment variables are correctly set.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-cron-schedule-is-daily-10am-not-hourly-defeats-sub — Cron schedule is daily (10am), not hourly — defeats sub-24h delay sequences

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Cron schedule is daily (10am), not hourly — defeats sub-24h delay sequences
**Type:** bug
**Severity:** high
**Source:** Product review c25afcd0-5e0d-4a7f-a19d-53c88b8f2f54

**Details:** vercel.json configures /api/cron/follow-up with schedule 0 10 * * * (once per day at 10am). Code comments say Runs every hour via Vercel Cron and defines delays of 30m, 4h, and 24h. Post-viewing (4h) and no-show (30m) sequences will never fire on schedule.

**Suggested fix:** Change vercel.json cron schedule from 0 10 * * * to 0 * * * * (every hour).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-production-endpoint-api-cron-follow-up-returns-404 — Production endpoint /api/cron/follow-up returns 404 on Vercel

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Production endpoint /api/cron/follow-up returns 404 on Vercel
**Type:** bug
**Severity:** high
**Source:** Product review c25afcd0-5e0d-4a7f-a19d-53c88b8f2f54

**Details:** curl https://leadflow-ai-five.vercel.app/api/cron/follow-up returns HTML 404 Cannot GET /api/cron/follow-up. The route exists locally but is not deployed or recognized by Vercel.

**Suggested fix:** Verify Vercel deployment includes the cron route and redeploy. Check build logs.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-trial-signup-form-reads-utm-from-url-params-not-se — trial-signup-form reads UTM from URL params, not sessionStorage — breaks first-touch attribution

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## trial-signup-form reads UTM from URL params, not sessionStorage — breaks first-touch attribution
**Type:** bug
**Severity:** high
**Source:** Product review c25c35e1-8803-4720-a29a-dc1cab8a9b7c

**Details:** components/trial-signup-form.tsx uses useSearchParams() to read UTM from current page URL. If user lands with UTM then navigates internally to /signup/trial, attribution is lost. The UtmCaptureTracker correctly stores to sessionStorage but form never reads it.

**Suggested fix:** Update form to call getUtmParams() from @/lib/utm-capture (reads sessionStorage key leadflow_utm).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-only-3-of-5-utm-params-captured-end-to-end-missing — Only 3 of 5 UTM params captured end-to-end (missing utm_content, utm_term)

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Only 3 of 5 UTM params captured end-to-end (missing utm_content, utm_term)
**Type:** spec_gap
**Severity:** high
**Source:** Product review c25c35e1-8803-4720-a29a-dc1cab8a9b7c

**Details:** API route only handles utm_source, utm_medium, utm_campaign. Form only sends these 3. PRD FR-3/FR-4 require all 5 columns.

**Suggested fix:** Update form and API to include utm_content and utm_term.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-no-global-sequences-dashboard-view — No global sequences dashboard view

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## No global sequences dashboard view
**Type:** gap
**Severity:** high
**Source:** Product review ee4c24f6-fc06-44d9-bf30-f071aa4d3fb2

**Details:** UC-8 AC: Active sequences visible in dashboard. Only visible per-lead on detail page. No /dashboard/sequences global view.

**Suggested fix:** Add /dashboard/sequences listing all active sequences.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-two-tests-failing-in-sms-stats-test-ts — Two tests failing in sms-stats.test.ts

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Two tests failing in sms-stats.test.ts
**Type:** test_failure
**Severity:** high
**Source:** Product review 5b8b0c51-b037-4845-b592-2fdc55f77b28

**Details:** Tests fail due to the twilio_status column bug. Once fixed, tests should pass.

**Suggested fix:** Fix the column name in route.ts first
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-active-setup-wizard-missing-twilio-phone-provision — Active /setup wizard missing Twilio phone provisioning step (US-3)

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Active /setup wizard missing Twilio phone provisioning step (US-3)
**Type:** feature_gap
**Severity:** high
**Source:** Product review 254b33f7-a001-4ff4-a2f7-398b4b3f9f54

**Details:** Login → /setup uses OLD flow: fub→sms→simulator→complete. No phone provisioning step. OnboardingWizardOverlay has correct fub→twilio→sms-verify flow but is not wired to login.

**Suggested fix:** Update /setup/page.tsx to use fub-step.tsx, twilio.tsx, sms-verify.tsx, completion-step.tsx.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-sms-verify-tsx-calls-deprecated-endpoint-sms-verif — sms-verify.tsx calls deprecated endpoint — sms_verified never written to DB

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## sms-verify.tsx calls deprecated endpoint — sms_verified never written to DB
**Type:** bug
**Severity:** high
**Source:** Product review 254b33f7-a001-4ff4-a2f7-398b4b3f9f54

**Details:** sms-verify.tsx calls /api/integrations/twilio/send-test (no DB update). Correct endpoint: /api/agents/onboarding/verify-sms (sets sms_verified=true).

**Suggested fix:** Change endpoint in sms-verify.tsx.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-form-funnel-events-never-fired-trackformevent-impo — Form funnel events never fired — trackFormEvent imported but not called

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Form funnel events never fired — trackFormEvent imported but not called
**Type:** bug
**Severity:** high
**Source:** Product review ada76402-4cfe-4e20-b696-36fdef799e3f

**Details:** In components/trial-signup-form.tsx, trackFormEvent is imported but never called. FR-3/AC-4/AC-5/AC-6 events (form_open, form_submit, form_success, form_error) are completely absent. FormFunnelEvent type also uses different names than PRD schema.

**Suggested fix:** Add trackFormEvent calls in trial-signup-form.tsx at: form mount (form_open), handleSubmit start (form_submit), API success (form_success), API error (form_error). Align event names with PRD schema.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-ga4-measurement-id-is-placeholder-g-test-placehold — GA4 Measurement ID is placeholder G-TEST-PLACEHOLDER — no data collection

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## GA4 Measurement ID is placeholder G-TEST-PLACEHOLDER — no data collection
**Type:** bug
**Severity:** high
**Source:** Product review ada76402-4cfe-4e20-b696-36fdef799e3f

**Details:** NEXT_PUBLIC_GA4_MEASUREMENT_ID=G-TEST-PLACEHOLDER in .env.production.local. No real GA4 property exists. All events fire into void. Zero analytics data collected.

**Suggested fix:** Stojan: Create GA4 property at analytics.google.com, add web stream for leadflow-ai-five.vercel.app, set real Measurement ID in Vercel env vars (Production + Preview).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-form-funnel-events-never-fire-trackformevent-impor — Form funnel events never fire — trackFormEvent imported but not called

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Form funnel events never fire — trackFormEvent imported but not called
**Type:** bug
**Severity:** high
**Source:** Product review 717eec7f-0266-4c06-82ca-bf10cb567279

**Details:** trial-signup-form.tsx imports trackFormEvent from @/lib/analytics/ga4 but never calls it. form_start (on field focus), form_submit_attempt (pre-submit), and pilot_signup_complete (on successful signup) are all missing. Conversion tracking is completely dark at the most critical stage of the funnel.

**Suggested fix:** Add onFocus on first field → trackFormEvent(form_start). Add trackFormEvent(form_submit_attempt) before fetch. Add trackFormEvent(pilot_signup_complete) before router.push on success.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-ga4-measurement-id-is-g-test-placeholder-no-analyt — GA4 Measurement ID is G-TEST-PLACEHOLDER — no analytics data flows

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## GA4 Measurement ID is G-TEST-PLACEHOLDER — no analytics data flows
**Type:** configuration
**Severity:** high
**Source:** Product review 717eec7f-0266-4c06-82ca-bf10cb567279

**Details:** NEXT_PUBLIC_GA4_MEASUREMENT_ID is set to G-TEST-PLACEHOLDER. GA4 requires a real property ID (G-XXXXXXXX). Until Stojan creates a GA4 property and sets the real ID in Vercel, zero events flow to Google Analytics regardless of code quality.

**Suggested fix:** Create GA4 property at analytics.google.com, copy Measurement ID, set NEXT_PUBLIC_GA4_MEASUREMENT_ID in Vercel env vars, trigger redeploy.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-leadflow-ai-vercel-project-has-3-consecutive-faili — leadflow-ai Vercel project has 3+ consecutive failing production deployments

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## leadflow-ai Vercel project has 3+ consecutive failing production deployments
**Type:** bug
**Severity:** high
**Source:** Product review ca772ad9-0461-4df9-a31c-124f34dbd75b

**Details:** The leadflow-ai Vercel project (backend Express API) has failed production deployments from 4h ago showing Error status with 0ms build time. Preview deployments are Ready but production alias is broken (500 errors).

**Suggested fix:** Investigate leadflow-ai production deployment failures. Check Vercel deploy logs.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-day-3-7-nurture-emails-have-no-scheduler — Day 3/7 nurture emails have no scheduler

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Day 3/7 nurture emails have no scheduler
**Type:** gap
**Severity:** high
**Source:** Product review 0ef1490d-889d-4050-8d61-4e113dc89fd0

**Details:** sendSocialProofEmail (Day 3) and sendPilotOfferEmail (Day 7) implemented in lib/lead-magnet-email.ts but never called. No cron route in vercel.json. PRD-specified 3-email sequence is incomplete.

**Suggested fix:** Add /api/cron/nurture-emails + vercel.json cron schedule.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-satisfaction-ping-route-still-queries-deprecated-a — satisfaction-ping route still queries deprecated agents table

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## satisfaction-ping route still queries deprecated agents table
**Type:** bug
**Severity:** high
**Source:** Product review bea25117-cedf-4946-9ce9-f2a5d92772fb

**Details:** product/lead-response/dashboard/app/api/agents/satisfaction-ping/route.ts has .from(agents) on lines 26 and 63. The correct table is real_estate_agents. This will cause 500 errors when agents try to toggle satisfaction ping.

**Suggested fix:** Replace .from(agents) with .from(real_estate_agents) in both PATCH and GET handlers in satisfaction-ping/route.ts
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-pilot-usage-endpoint-uses-api-secret-key-auth-inst — pilot-usage endpoint uses API_SECRET_KEY auth instead of SUPABASE_SERVICE_ROLE_KEY

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## pilot-usage endpoint uses API_SECRET_KEY auth instead of SUPABASE_SERVICE_ROLE_KEY
**Type:** bug
**Severity:** high
**Source:** Product review 516f29bd-0ee6-4c83-8571-9a6550cb08a8

**Details:** The GET /api/internal/pilot-usage route authenticates via API_SECRET_KEY bearer token. Test suite explicitly checks content.includes("SUPABASE_SERVICE_ROLE_KEY") — failing 1/15 tests. The endpoint also instantiates a Supabase client without service role key, risking RLS policy failures in production.

**Suggested fix:** Replace API_SECRET_KEY auth with SUPABASE_SERVICE_ROLE_KEY in the pilot-usage route. Use supabaseAdmin client from @/lib/db.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-confirmation-tsx-does-not-show-aha-moment-status-i — confirmation.tsx does not show Aha Moment status in Connected Integrations

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## confirmation.tsx does not show Aha Moment status in Connected Integrations
**Type:** bug
**Severity:** high
**Source:** Product review 4afbcedf-bce4-4a82-b1fd-e30a8e0f0e13

**Details:** Connected Integrations section only shows Cal.com Booking and Twilio SMS. No row for AI Lead Response. agentData.ahaCompleted is not referenced anywhere in confirmation.tsx. AC-7 and AC-8 fail.

**Suggested fix:** Add a third row in Connected Integrations: icon=🤖, label=AI Lead Response. Show (✓ Live (X.Xs response)) when ahaCompleted=true, (○ Skipped) when false. Read from agentData.ahaCompleted and agentData.ahaResponseTimeMs.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-anthropic-api-key-not-configured — ANTHROPIC_API_KEY not configured
...
**Details:** Missing API key causes fallback to mock mode.

**Suggested fix:** Set ANTHROPIC_API_KEY in Vercel environment
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-pilot-signup-sets-email-verified-true-on-creation- — Pilot signup sets email_verified: true on creation, bypassing login gate

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Pilot signup sets email_verified: true on creation, bypassing login gate
**Type:** bug
**Severity:** high
**Source:** Product review cfaeab07-6512-4e58-b97e-18aa5aaed26a

**Details:** In /api/auth/pilot-signup/route.ts line 206, the agent is created with email_verified: true. A verification email IS sent (non-blocking) but the login gate is never enforced — pilot agents can log in immediately without clicking the link.

**Suggested fix:** Remove email_verified: true override. Token creation and email send logic already exists in the route — just let them gate the login.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-project-config-json-dashboard-smoke-test-url-incor — project.config.json dashboard smoke test URL incorrect

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## project.config.json dashboard smoke test URL incorrect
**Type:** config
**Severity:** high
**Source:** Product review d32923eb-7d95-4bc4-b2f1-5fb1df5c24bb

**Details:** vercel-dashboard smoke test hits leadflow-ai-five.vercel.app/api/health which returns HTML error (Cannot GET). Express server, not Next.js.

**Suggested fix:** Update smoke test URL after deployment.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-url-mismatch-leadflow-ai-five-vercel-app-hosts-fub — URL mismatch: leadflow-ai-five.vercel.app hosts FUB webhook, not customer dashboard

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## URL mismatch: leadflow-ai-five.vercel.app hosts FUB webhook, not customer dashboard
**Type:** bug
**Severity:** high
**Source:** Product review 048c9be5-a0a4-4515-b06a-bf957e80aabb

**Details:** project.config.json lists leadflow-ai-five.vercel.app as the customer-dashboard URL. That URL returns FUB webhook JSON. The Next.js dashboard Vercel project is named leadflow-ai per .vercel/project.json.

**Suggested fix:** Update project.config.json URLs to https://leadflow-ai.vercel.app after confirming deployment.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-env-var-naming-inconsistency-pro-vs-professional-b — Env var naming inconsistency: PRO vs PROFESSIONAL between checkout and webhook routes

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Env var naming inconsistency: PRO vs PROFESSIONAL between checkout and webhook routes
**Type:** bug
**Severity:** high
**Source:** Product review 9aecd031-8508-4601-94a6-d5790f400a2f

**Details:** Checkout route uses STRIPE_PRICE_PRO_MONTHLY. Webhook getTierFromPriceId() uses process.env.STRIPE_PRICE_PROFESSIONAL_MONTHLY. Pro tier webhook mapping will silently fail — tier defaults to professional instead of pro.

**Suggested fix:** Fix webhooks/stripe/route.ts: change STRIPE_PRICE_PROFESSIONAL_MONTHLY to STRIPE_PRICE_PRO_MONTHLY. Same for annual variants.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-url-routing-mismatch-leadflow-ai-five-vercel-app-s — URL routing mismatch: leadflow-ai-five.vercel.app serves Express, not Next.js dashboard

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## URL routing mismatch: leadflow-ai-five.vercel.app serves Express, not Next.js dashboard
**Type:** bug
**Severity:** high
**Source:** Product review 9aecd031-8508-4601-94a6-d5790f400a2f

**Details:** PRD references leadflow-ai-five.vercel.app as production URL, but billing APIs live in the separate leadflow-ai Vercel project (prj_p9ZX952UhE1cl1PYZAgVW53FqVm9). 404 on all /api/billing/* calls.

**Suggested fix:** Update NEXT_PUBLIC_APP_URL and PRD references to point to the correct Next.js dashboard URL (leadflow-ai.vercel.app or custom domain).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-lead-detail-page-uses-old-conversationview-not-the — Lead detail page uses old ConversationView, not the new ConversationViewV2 with UC-7 integration

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Lead detail page uses old ConversationView, not the new ConversationViewV2 with UC-7 integration
**Type:** bug
**Severity:** high
**Source:** Product review 678e6d4c-363e-4536-a971-e7c487f668a1

**Details:** app/dashboard/leads/[id]/page.tsx imports ConversationView (old) instead of ConversationViewV2. The new ConversationViewV2 component correctly integrates MessageThread + SmsComposer and calls /api/sms/send-manual — but it is never used in production. The old ConversationView calls /api/sms/send (a different endpoint). This means the UC-7 Manual SMS feature is built but not wired into the UI.

**Suggested fix:** Replace import { ConversationView } with import { ConversationViewV2 } in app/dashboard/leads/[id]/page.tsx and update the JSX to use <ConversationViewV2> instead of <ConversationView>.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-cron-endpoint-uses-postgrest-client-not-service-ro — Cron endpoint uses PostgREST client not service role key

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Cron endpoint uses PostgREST client not service role key
**Type:** bug
**Severity:** high
**Source:** Product review 8ef5dd8c-5179-43b4-add3-8742932517ec

**Details:** check-stuck-agents/route.ts uses createClient from @/lib/db with NEXT_PUBLIC_API_URL and API_SECRET_KEY. Should use supabaseServer from @/lib/supabase-server for privileged server-side access. Causes test failure and will fail in production if RLS is enabled.

**Suggested fix:** Replace createClient(@/lib/db) with supabaseServer import from @/lib/supabase-server in check-stuck-agents route, same pattern as admin/funnel/route.ts.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-product-feedback-insert-missing-processed-false-an — product_feedback insert missing processed:false and wrong data schema

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## product_feedback insert missing processed:false and wrong data schema
**Type:** bug
**Severity:** high
**Source:** Product review 5584f89e-9c32-4e9a-b6d1-06c0daf0d032

**Details:** PRD FR-5.3 requires processed:false, data.summary, data.details, data.stuck_step (numeric index), data.stuck_step_name. Implementation omits processed:false and uses alert_type/step_name/step_index instead of the specified fields.

**Suggested fix:** Add processed:false. Align data fields to PRD spec: summary, details, stuck_step, stuck_step_name, hours_stuck.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-fix-confirmed-subscription-attempts-replaced-with- — Fix confirmed: subscription_attempts replaced with checkout_sessions

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Fix confirmed: subscription_attempts replaced with checkout_sessions
**Type:** fix_verified
**Severity:** high
**Source:** Product review e320458f-6e09-488b-b994-18d908616380

**Details:** The PGRST205 bug has been resolved. route.ts now inserts into checkout_sessions with correct column mapping: user_id (from agentId), tier (split from combined tier string), interval (month/year), stripe_session_id, status=pending, url, expires_at.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-return-value-mismatch-returns-success-alerts-creat — Return value mismatch: returns {success, alerts_created} not {inserted, skipped}

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Return value mismatch: returns {success, alerts_created} not {inserted, skipped}
**Type:** bug
**Severity:** high
**Source:** Product review 5584f89e-9c32-4e9a-b6d1-06c0daf0d032

**Details:** PRD FR-5.2 and AC-6 require createStuckAlerts() to return {inserted: N, skipped: M}. Implementation returns {success: true, alerts_created: N, alerts: [...]}. No skipped counter.

**Suggested fix:** Track inserted/skipped counters and return { inserted, skipped }.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-no-http-endpoint-fr-5-5-and-ac-7-not-implemented — No HTTP endpoint — FR-5.5 and AC-7 not implemented

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## No HTTP endpoint — FR-5.5 and AC-7 not implemented
**Type:** gap
**Severity:** high
**Source:** Product review 5584f89e-9c32-4e9a-b6d1-06c0daf0d032

**Details:** No /api/internal/stuck-alerts route exists. pages/api/internal/ directory does not exist. AC-7 fails.

**Suggested fix:** Create pages/api/internal/stuck-alerts.js POST handler calling checkAndAlertStuckAgents(supabase).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-idempotency-dedup-logic-not-defined — Idempotency/dedup logic not defined

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Idempotency/dedup logic not defined
**Type:** gap
**Severity:** high
**Source:** Product review d04792da-1f6d-4cb1-a0ac-73e8f683a19b

**Details:** AC-5 requires no duplicate sends. Need tracking table (nurture_email_sends) with (subscriber_id, day, sent_date) to prevent re-sends.

**Suggested fix:** Add nurture_email_sends table migration OR use day_3_sent, day_7_sent flags in pilot_signups
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
### fix-satisfaction-ping-route-ts-still-queries-agents-ta — satisfaction-ping/route.ts still queries agents table instead of real_estate_agents

- **PRD:** Fix satisfaction-ping API — Wrong Table Reference
- **Status:** not_started
- **Priority:** 2
- **Description:** ## satisfaction-ping/route.ts still queries agents table instead of real_estate_agents
**Type:** bug
**Severity:** high
**Source:** Product review 0526e1b5-a680-4432-97f9-b901a3cb1468

**Details:** The file product/lead-response/dashboard/app/api/agents/satisfaction-ping/route.ts has 2 supabase.from("agents") calls (lines 26 and 63) that should be real_estate_agents. This was intentionally reverted per commit 7c272b8f ("fix: query agents table (not real_estate_agents) for satisfaction_ping_enabled"), but the agents table is the orchestrator metadata table — not the customer table. The real_estate_agents table also has satisfaction_ping_enabled column. The route serves /api/agents/satisfaction-ping with an agentId that should be a real estate agent customer ID.

**Suggested fix:** Change both supabase.from("agents") calls in satisfaction-ping/route.ts to supabase.from("real_estate_agents"). Also verify that satisfaction_ping_enabled column exists on real_estate_agents (it does). Delete the column from the agents (orchestrator) table if it was added by mistake.
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
- **Acceptance Criteria:**
  - AC-1: No .from(agents) in satisfaction-ping route (grep returns 0). AC-2: File contains exactly 2 references to real_estate_agents. AC-3: PATCH and GET handlers both query real_estate_agents for satisfaction_ping_enabled. Human test: agent can toggle satisfaction ping on/off in dashboard settings without error.
- **Workflow:** Dev > QC

### fix-email-templates-not-integrated — Email templates not integrated

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** ## Email templates not integrated
**Type:** gap
**Severity:** high
**Source:** Product review d04792da-1f6d-4cb1-a0ac-73e8f683a19b

**Details:** AC-1 through AC-4 require formatted emails (social proof for Day 3, pilot offer for Day 7). No Resend email template references in code.

**Suggested fix:** Use existing Resend integration pattern from lead-magnet emails. Define templates with personalization (subscriber name, signup date).
## Acceptance Criteria
- The issue described above is resolved
- Existing functionality is not broken
- Tests pass
...
- **Status:** not_started
- **Priority:** 2
- **Description:** Demo mode: agent enters fake lead data post-signup, AI responds in <30s, no FUB required. 3-demo limit then FUB connect CTA. Removes #1 onboarding friction; expected 2x+ improvement in activation rate.
- **Acceptance Criteria:**
  - ["POST /api/demo/run with valid auth returns { success: true, ai_response } within 30 seconds","After 3 demo runs, POST /api/demo/run returns { error: demo_limit_reached }","agents.demo_runs_used incremented correctly after each run","Twilio send API NOT called during demo run","FUB contact creation API NOT called during demo run","demo_runs table row created for each demo run","/dashboard/demo route renders demo form","Demo CTA appears in onboarding wizard when fub_connected = false","Agent with no FUB credentials can run demo successfully"]
- **Workflow:** PM > Dev > QC
...
### uc-smoke-loop-dedup — Smoke Test Loop Prevention

- **PRD:** Fix Smoke Loop V4 — Vercel Dashboard Health (Fourth Attempt)
- **Status:** not_started
- **Priority:** 3
- **Description:** Smoke handler must not create more than 1 QC task per 2h window
- **Acceptance Criteria:**
  - 1. findLatestTaskByTitle exists in genome task-store.js
2. Smoke handler uses findLatestTaskByTitle (not findTaskByTitle)
3. lastTaskCreated written to .smoke-test-state.json after QC task creation
4. Cooldown check uses lastTaskCompleted || lastTaskCreated
5. ≤1 QC smoke task per 2h window across 10 consecutive heartbeats
6. Git commit in ~/.openclaw/genome/ with these changes
7. curl https://leadflow-ai-five.vercel.app/api/health returns status:ok (no supabase_connectivity error)
- **Workflow:** PM > Dev > QC


## Phase: revenue-emergency

### feat-stripe-keys-vercel — Deploy Stripe API keys to Vercel production

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 1
- **Description:** Deploy STRIPE_SECRET_KEY and STRIPE_WEBHOOK_SECRET to Vercel env vars. Blocks ALL checkout flows.
- **Workflow:** PM > Dev > QC

### fix-session-token-consistency — Standardize auth cookie names across signup/login/checkout flows

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 1
- **Description:** Trial-signup sets auth-token cookie but middleware reads leadflow_session. Session breaks during checkout.
- **Workflow:** PM > Dev > QC

### fix-onboarding-wizard-blocks-dashboard — Unblock agents from onboarding wizard → allow direct dashboard access

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 1
- **Description:** 379 agents (96%) stuck in onboarding status. Complete wizard UI or skip for trial agents.
- **Workflow:** PM > Dev > QC

### fix-stripe-webhook-integration — Verify Stripe webhook processes subscription.created and updates agent records

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 1
- **Description:** Webhook must create subscription record in real_estate_agents table after checkout succeeds.
- **Workflow:** PM > Dev > QC

### feat-checkout-page-stripe-elements — Create functional checkout page with Stripe Elements integration

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 1
- **Description:** Create /checkout page with Stripe Elements form. Agents cannot complete purchase without this.
- **Workflow:** PM > Dev > QC

### email-campaign-trial-ready — Email campaign: "Your trial is ready — unlock unlimited AI responses"

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 2
- **Description:** Send email to trial agents with direct checkout link. Target: convert 50-100 agents by day 50.
- **Workflow:** PM > Dev > QC

### dashboard-trial-activation-sequence — Add trial activation sequence: aha moment (day 1), upgrade CTA (day 3), urgency (day 10-13)

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 2
- **Description:** In-app notifications: day 1 demo, day 3 pricing, day 10-13 final offer.
- **Workflow:** PM > Dev > QC

### sales-outreach-active-agents — Personal sales outreach to 10 "active" status agents — convert 3-5 to Team tier

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 2
- **Description:** Quick win: 5 agents × $399/mo Team = $1,995/mo. Proof of sales model.
- **Workflow:** PM > Dev > QC

### fix-ga4-tracking-complete — Complete GA4 instrumentation: scroll depth, CTA clicks, checkout page views

- **PRD:** Revenue Recovery — Emergency Response
- **Status:** ready
- **Priority:** 2
- **Description:** Understand funnel leaks via GA4. Currently scroll depth and CTA tracking incomplete.
- **Workflow:** PM > Dev > QC


## Phase: stabilization

### uc-auto-trigger-onboarding-post-verify — Auto-Trigger Onboarding Wizard After Email Verification
...
- **Acceptance Criteria:**
  - Verified agents (email_verified=true) automatically enter onboarding wizard. Acceptance check: SELECT COUNT(*) FROM real_estate_agents WHERE email_verified=true AND onboarding_step > 0 >= 50
- **Workflow:** PM > Dev > QC

### uc-phase2-aha-moment-simulator — Phase 2A: Aha Moment Simulator Integration into Onboarding

- **PRD:** Revenue Critical (MRR) — Gap Analysis & Prioritized Recovery Plan
- **Status:** ready
- **Priority:** 1
- **Description:** Wire lead simulator component into onboarding wizard (step 5) and auto-load demo leads on first dashboard view
- **Acceptance Criteria:**
  - Simulator in onboarding step 5; new agents see 3+ demo leads on first login; SMS delivery <2s
- **Workflow:** PM > Design > Dev > QC

### uc-phase2-self-serve-upgrade — Phase 2B: Self-Serve Upgrade Flow (Stripe Checkout + Trial Countdown)

- **PRD:** Revenue Critical (MRR) — Gap Analysis & Prioritized Recovery Plan
- **Status:** ready
- **Priority:** 1
- **Description:** Create /upgrade page, add Upgrade button to dashboard, trial countdown timer, Stripe checkout integration
- **Acceptance Criteria:**
  - Upgrade button in dashboard; /upgrade page with plan details; Stripe checkout works; trial timer displays
- **Workflow:** PM > Design > Dev > QC

### uc-trial-to-paid-conversion-flow — Trial-to-Paid Email Sequence & Stripe Checkout Integration
...
- **Acceptance Criteria:**
  - First paid conversion succeeds end-to-end. Acceptance check: SELECT COUNT(*) FROM real_estate_agents WHERE subscription_status='active' AND mrr > 0 >= 1
- **Workflow:** PM > Dev > QC

### uc-fix-onboarding-aha-moment — Fix Onboarding Wizard Aha Moment — Live Lead Simulator
...
- **Acceptance Criteria:**
  - Agents see live lead simulator with AI response in <30 seconds. FUB connection is optional. Acceptance check: SELECT COUNT(*) FROM real_estate_agents WHERE onboarding_completed=true AND (fub_connected=true OR phone_configured=true) >= 4
- **Workflow:** PM > Dev > QC

### uc-phase2-trial-expiry-emails — Phase 2C: Trial Expiry Email Sequence & Upgrade Links

- **PRD:** Revenue Critical (MRR) — Gap Analysis & Prioritized Recovery Plan
- **Status:** ready
- **Priority:** 2
- **Description:** Automated emails on Days 10, 13, 14 of trial with one-click upgrade links with agent ID pre-populated
- **Acceptance Criteria:**
  - Emails sent Days 10, 13, 14; upgrade links with agent_id in Stripe metadata
- **Workflow:** PM > Marketing > Dev > QC


## Phase: ready

### uc-loop-cooldown-24h — GENOME: Add 24h cooldown to loop detector meta-task creation

- **PRD:** Revenue Alert Loop — Root Cause & Fix Specification
- **Status:** not_started
- **Priority:** 1
- **Description:** Prevent duplicate "PM: Loop detected" meta-tasks by checking if we created one for the same pattern in the last 24h. This prevents task spam when the same underlying issue repeats within a 24-hour window.
- **Acceptance Criteria:**
  - No duplicate meta-tasks created for the same underlying duplicate pattern within 24h. Each unique loop pattern gets ONE investigation task per 24h window.
- **Workflow:** PM > Dev > QC

### uc-dedup-key-migration — Add dedup_key Schema Migration

- **PRD:** Add dedup_key Column to tasks Table
- **Status:** not_started
- **Priority:** 1
- **Description:** Add dedup_key column to tasks table to fix task deduplication in TaskStore
- **Acceptance Criteria:**
  - ["Column dedup_key exists in tasks table","Column is VARCHAR(255), nullable","Index idx_tasks_project_dedup exists on (project_id, dedup_key)","TaskStore can query tasks by dedup_key without errors","Revenue alerts deduplicate correctly","Loop detection task creation respects dedup logic"]
- **Workflow:** PM > Dev > QC

### uc-task-timeout-reaper — GENOME: Auto-timeout stuck PM tasks after 30min

- **PRD:** Revenue Alert Loop — Root Cause & Fix Specification
- **Status:** not_started
- **Priority:** 1
- **Description:** Implement a background job that checks every 10 minutes for PM tasks stuck in in_progress for >30min and marks them as failed with reason "task_timeout". This prevents stale tasks from accumulating.
- **Acceptance Criteria:**
  - No PM task hangs in in_progress indefinitely. Failed tasks are logged to product_feedback for later analysis. Loop detector treats failed tasks as "resolved" (doesn't create new meta-tasks).
- **Workflow:** PM > Dev > QC

### uc-revenue-alert-loop-dedup — Fix Revenue Alert Task Loop — Deduplication

- **PRD:** Revenue Recovery — 7-Day Critical Action Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Implement deduplication check in revenue-collector.js (Genome) to prevent duplicate "PM: Revenue alert" tasks from being created every heartbeat.
- **Acceptance Criteria:**
  - No duplicate revenue alert tasks in ready status; loop detector does not trigger; new tasks created when trajectory changes; completed tasks allow new alerts
- **Workflow:** PM > Dev > QC

### uc-loop-auth-failure-guard — GENOME: Guard loop detection against auth failures

- **PRD:** Revenue Alert Loop — Root Cause & Fix Specification
- **Status:** not_started
- **Priority:** 2
- **Description:** If PM agent fails with auth-related error (e.g., FailoverError for unavailable profiles), don't create a new meta-task. Instead, log to product_feedback with feedback_type="auth_failure" for dev/infra to investigate.
- **Acceptance Criteria:**
  - Auth failures are visibly reported, not silently repeated. Loop detector doesn't create new meta-tasks for auth failures. Developer can see the pattern and fix it (increase auth profile pool, add fallback model, etc.).
- **Workflow:** PM > Dev > QC


## Phase: pilot

### uc-phase1-manual-pilot-onboarding — Phase 1: Manual Pilot Onboarding (3 Agents to Pro Tier)

- **PRD:** Revenue Critical (MRR) — Gap Analysis & Prioritized Recovery Plan
- **Status:** ready
- **Priority:** 1
- **Description:** Onboard 3 pilot agents with real FUB integrations and upgrade to Pro tier ($149/mo) to generate initial $447 MRR
- **Acceptance Criteria:**
  - All 3 pilot agents have subscription_status=active, plan_tier=pro, confirmed Stripe subscription $149/mo
- **Workflow:** PM > Marketing > QC

### uc-revenue-critical-2026-q1 — Revenue Alert Critical — Close $20K MRR Gap

- **PRD:** Revenue Alert Critical — MRR Closure Plan
- **Status:** ready
- **Priority:** 1
- **Description:** Execute white-glove pilot with 3 real agents, define trial-to-paid conversion, and scale to 75+ agents.
- **Acceptance Criteria:**
  - Day 30: 3 paying agents. Day 60: 50 agents, $5K MRR. Day 90: 75+ agents, $15K+ MRR.
- **Workflow:** PM > Dev > QC

### uc-revenue-recovery-critical-2026-03-31 — Revenue Recovery — Critical MRR Action Plan

- **PRD:** Revenue Alert — Critical MRR Recovery Plan
- **Status:** not_started
- **Priority:** 1
- **Description:** Unblock trial → paid conversion pipeline. Root cause: Zero revenue despite functional MVP. Three blockers: (1) Stripe keys not in Vercel prod, (2) Pilot recruitment frozen 17+ days, (3) Onboarding UX gaps. Acceptance: Stripe 200s, landing CTA visible, real agents>0, paid agents>0, MRR>0.
- **Acceptance Criteria:**
  - ["AC-1: STRIPE_SECRET_KEY + STRIPE_WEBHOOK_SECRET configured in Vercel leadflow-ai","AC-2: Landing page has visible \"Start Free Trial\" CTA above fold","AC-3: Onboarding wizard auto-launches when onboarding_completed=false","AC-4: DB queries use correct table (real_estate_agents not agents)","AC-5: 3 real agents invited via admin invite flow","AC-6: At least 1 real agent converted to paid tier","AC-7: MRR > $0 (system is revenue-generating)","AC-8: Onboarding telemetry dashboard live (/admin/funnel)"]
- **Workflow:** PM > Dev > QC

### uc-pilot-recruitment-unblock — Action 1: Unblock Real Pilot Recruitment

- **PRD:** Revenue Recovery — Critical Path to $20K MRR
- **Status:** ready
- **Priority:** 1
- **Description:** Get Stojan approval, activate marketing, acquire 5–10 real agents by 2026-04-03.
- **Workflow:** PM > Dev > QC

### uc-stripe-checkout-fix — Action 2: Fix Stripe Checkout Production Bug

- **PRD:** Revenue Recovery — Critical Path to $20K MRR
- **Status:** ready
- **Priority:** 1
- **Description:** Set STRIPE_SECRET_KEY in Vercel to enable paid upgrades.
- **Workflow:** PM > Dev > QC

### uc-real-agent-filter — Action 3: Real-Agent Isolation Filter

- **PRD:** Revenue Recovery — Critical Path to $20K MRR
- **Status:** ready
- **Priority:** 1
- **Description:** Add is_real_agent column, filter test accounts, create clean metrics view.
- **Workflow:** PM > Dev > QC

### uc-fix-smoke-loop — Fix: Smoke test loop — Vercel dashboard health tasks duplicating infinitely

- **PRD:** Fix Smoke Test Loop — Vercel Dashboard Health
- **Status:** in_progress
- **Priority:** 1
- **Description:** The orchestrator smoke handler creates an infinite loop of QC tasks because findTaskByTitle excludes done tasks (dedup broken) and lastTaskCompleted is never written (cooldown broken). Fix both bugs to restore the QC→Dev escalation chain and circuit breaker.
- **Acceptance Criteria:**
  - No more than 1 QC smoke task created per failing smoke test across 10 consecutive heartbeats
  - After QC task completes, next heartbeat creates Fix: dev task not another Smoke: QC task
  - lastTaskCompleted field is written to .smoke-test-state.json when a smoke task completes
  - Circuit breaker fires after MAX_SMOKE_RETRIES dev completions with smoke still failing
  - No duplicate ready/running smoke tasks exist in the tasks table
- **Workflow:** Dev

### uc-cta-click-tracking-landing-page — Wire CTA Click Tracking on Landing Page (page.tsx)

- **PRD:** -
- **Status:** complete
- **Priority:** 2
- **Description:** All CTA buttons on the main landing page (app/page.tsx) fire trackCTAClick() GA4 events with correct cta_id, cta_label, and section params. Every clickable CTA element has a data-cta-id attribute. The ga4 analytics library (lib/analytics/ga4.ts) handles SSR safety and event firing.
- **Acceptance Criteria:**
  - AC-1: GET / renders elements with data-cta-id attributes: join_pilot_nav, sign_in_nav, see_how_it_works, start_trial_features, pricing_starter, pricing_pro, pricing_team, start_trial_pricing
  - AC-2: Clicking each CTA calls window.gtag("event", "cta_click", { cta_id, cta_label, section }) with correct params
  - AC-3: lib/analytics/ga4.ts trackCTAClick() is a no-op when window.gtag is undefined (SSR safe)
  - AC-4: ga4.ts exports trackCTAClick, trackScrollMilestone, trackFormEvent, attachScrollMilestoneObservers
  - AC-5: All CTAs in navigation, hero, features, testimonials, and pricing sections have onClick handlers calling trackCTAClick
- **Depends on:** UC-LANDING-ANALYTICS-GA4-001
- **Workflow:** QC

### decommission-legacy-twilio-inbound-handler — Decommission legacy integrations/twilio-inbound-sms.js handler

- **PRD:** -
- **Status:** not_started
- **Priority:** 2
- **Description:** The Next.js route handler at /api/webhook/twilio/route.ts is the canonical Twilio inbound SMS handler (deployed, TCPA-correct). The legacy Express handler at integrations/twilio-inbound-sms.js mounted in server.js is redundant and must be removed to prevent dual-handler confusion and routing ambiguity in production.
- **Acceptance Criteria:**
  - DELETE integrations/twilio-inbound-sms.js from the repository
  - REMOVE the require("./integration/twilio-inbound-sms") line from server.js
  - REMOVE app.use("/", twilioInboundRouter) from server.js
  - Verify server.js still starts without errors after removal
  - POST /api/webhook/twilio (Next.js handler) returns 200 for a valid Twilio request
  - No references to twilio-inbound-sms remain in server.js
  - npm test passes after changes
  - Twilio console webhook URL confirmed pointing to Next.js endpoint: https://<vercel-domain>/api/webhook/twilio
- **Workflow:** Dev > QC
...
- **Status:** not_started
- **Priority:** 1
- **Description:** Prevent distribution health check from creating duplicate PM tasks by adding UC completion gate, 48h task cooldown, and loose channel check.
- **Acceptance Criteria:**
  - {"id":"no-duplicate-tasks-48h","description":"No duplicate distribution tasks created within 48h cooldown"}
  - {"id":"uc-completion-gate","description":"UC completion status checked before raising distribution issues"}
  - {"id":"loose-channel-check","description":"Channel existence check removes active-only filter"}
  - {"id":"skip-logging","description":"Skipped issues are logged with reason"}
- **Workflow:** PM > Dev > QC


## Phase: specification

### uc-distribution-loop-fix — Fix Distribution Health Loop — Stop Repeated Landing Page Task Spawning

- **PRD:** Distribution Loop — Wave 10 Escalation
- **Status:** not_started
- **Priority:** 1
- **Description:** The distribution-collector health check spawns PM: Distribution — Create Landing Page every heartbeat because: (1) it queries distribution_channels which does not exist, (2) no dedup guard prevents re-spawning completed tasks, (3) loop detection fires investigation tasks that also loop. Fix requires: create distribution_channels table OR add cooldown check in genome distribution-collector script.
- **Acceptance Criteria:**
  - {"id":"distribution-channels-exists","command":"psql postgresql://clawdbot@localhost/openclaw -tAc \"SELECT COUNT(*) FROM distribution_channels WHERE project_id='leadflow' AND channel_type='landing_page' AND status='active'\"","expected":"1","description":"distribution_channels table exists with active leadflow landing page row"}
  - {"id":"dc-has-uc-gate","command":"grep -c 'completedUcIds\\|UC_ISSUE_MAP' ~/.openclaw/genome/scripts/distribution-collector.js","expected":"2","description":"UC completion gate added to distribution-collector.js"}
  - {"id":"dc-has-cooldown","command":"grep -c 'thirtyMinutesAgo' ~/.openclaw/genome/scripts/distribution-collector.js","expected":"1","description":"30-min cooldown guard added to createDistributionTasks()"}
  - {"id":"ts-has-timestamp-dedup","command":"grep -c 'thirtyMinutesAgo' ~/.openclaw/genome/core/task-store.js","expected":"1","description":"Loop detector uses timestamp dedup instead of status-only"}
- **Workflow:** Dev > QC

### uc-loop-detection-handler-fix — Fix Loop Detection Handler Duplicate Investigations

- **PRD:** Loop Detection Handler — Prevent Duplicate Investigations
- **Status:** in_progress
- **Priority:** 1
- **Description:** Implement timestamp-based deduplication in task-store.js to prevent creating duplicate "PM: Loop detected" investigation tasks within 30 minutes when the same loop is detected across consecutive heartbeats.
- **Acceptance Criteria:**
  - {"id":"check-no-duplicate-invs","command":"grep -n \"Loop investigation already created this heartbeat\" ~/.openclaw/genome/core/task-store.js","expected":"1"}
  - {"id":"check-timestamp-gate","command":"grep -n \"thirtyMinutesAgo\" ~/.openclaw/genome/core/task-store.js","expected":"1"}
- **Workflow:** PM > Dev > QC


## Phase: recruitment

### uc-manual-pilot-recruitment — Manual Pilot Recruitment — 5 Real Agents, White-Glove Onboarding
...
- **Acceptance Criteria:**
  - Acceptance check: SELECT COUNT(*) FROM real_estate_agents WHERE source='pilot' AND subscription_status='active' AND mrr > 0 >= 2
- **Workflow:** PM > Dev > QC


## Phase: Phase 2 - Nurture Automation

### uc-nurture-seq-scheduler-vercel-cron-001 — Implement: Nurture sequence scheduling via Vercel Cron

- **PRD:** Lead Magnet / Email Capture on Landing Page
- **Status:** not_started
- **Priority:** 1
- **Description:** Create /api/cron/nurture-emails endpoint and configure vercel.json cron schedule to dispatch Day 3 (social proof) and Day 7 (pilot offer) emails to lead magnet subscribers.
- **Acceptance Criteria:**
  - GET /api/cron/nurture-emails responds with HTTP 200
  - Cron executes daily at 9 AM UTC
  - Day 3 email sent to pilot_signups created 3+ days ago
  - Day 7 email sent to pilot_signups created 7+ days ago
  - Emails idempotent (not re-sent to same recipient)
  - Vercel logs show scheduled cron executions
  - Email tracking pixels and unsubscribe links functional
- **Workflow:** Dev > QC


## Phase: Critical Path

### uc-fix-email-verification-day47 — Fix Email Verification Pipeline
...
### uc-auto-trigger-onboarding-day47 — Auto-Trigger Onboarding Wizard
...
### uc-enable-trial-to-paid-checkout-day47 — Enable Trial-to-Paid Conversion (Checkout + Email)
...
### uc-phase2-ga4-analytics — Phase 2D: GA4 Conversion Funnel Analytics

- **PRD:** Revenue Critical (MRR) — Gap Analysis & Prioritized Recovery Plan
- **Status:** ready
- **Priority:** 2
- **Description:** Google Analytics 4 tracking for: signup → email verification → onboarding → aha moment → upgrade → payment
- **Acceptance Criteria:**
  - GA4 script in layout.tsx; 7 conversion events firing; funnel analysis in GA4 dashboard
- **Workflow:** PM > Dev > QC


## Phase: MVP

### feat-canonical-wizard-setup-swap — Canonical Wizard: Swap Components in /setup Route

- **PRD:** PRD: Canonical Wizard Component Swap — /setup Route
- **Status:** ready
- **Priority:** 2
- **Description:** Replace setup/page.tsx imports to use canonical -step components (fub-step, sms-verify-step, completion-step) for consistent architecture.
- **Acceptance Criteria:**
  - FubStep (fub-step.tsx) integrated with token prop
  - SmsVerifyStep (sms-verify-step.tsx) integrated with token prop
  - CompletionStep (completion-step.tsx) integrated with token prop
  - Setup step progression works (1→2→3→4)
  - All 4 steps render correctly on desktop and mobile
