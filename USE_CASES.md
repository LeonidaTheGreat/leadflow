...
> Generated: 2026-03-11T08:41:19.238Z | Source: `use_cases` + `prds` tables

**Progress: 121/129 complete**
...
| fix-onboarding-still-present-in-auth-routes-middleware | /onboarding still present in AUTH_ROUTES (middleware.ts line 21) | - | in_progress | 2 | - | Dev > QC |
...
| fix-api-start-action-requires-sessionid-before-session | API start action requires sessionId before sessionId exists — chicken-and-egg | - | in_progress | 2 | - | Dev > QC |
