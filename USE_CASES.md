...
> Generated: 2026-03-15T07:38:36.076Z | Source: `use_cases` + `prds` tables

**Progress: 163/170 complete**
...
| fix-use-cases-implementation-status-marked-complete-bu | use_cases.implementation_status marked complete but feature is non-functional | - | in_progress | 2 | - | Dev > QC |
...
| fix-fr5-stuck-alert-product-feedback-missing | FR-5: createStuckAlerts() missing product_feedback insert | Phase 1 | in_progress | 2 | defined | Dev > QC |
...
| fix-landing-page-page-tsx-has-zero-cta-click-analytics | Landing page (page.tsx) has zero CTA click analytics — trackCTAClick never called | - | in_progress | 2 | - | Dev > QC |
...
| fix-scroll-depth-tracking-not-wired-attachscrollmilest | Scroll depth tracking not wired — attachScrollMilestoneObservers never called on landing page | - | not_started | 2 | - | Dev > QC |
