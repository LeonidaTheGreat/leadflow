...
const ADMIN_MAGIC_LINK_TTL_HOURS = 24;
...
const stripe = {
  ...
  prices: {
    starter:      { month: process.env.STRIPE_PRICE_STARTER_MONTHLY,  year: process.env.STRIPE_PRICE_STARTER_ANNUAL },
    professional: { month: process.env.STRIPE_PRICE_PRO_MONTHLY,      year: process.env.STRIPE_PRICE_PRO_ANNUAL },
    enterprise:   { month: process.env.STRIPE_PRICE_TEAM_MONTHLY,     year: process.env.STRIPE_PRICE_TEAM_ANNUAL },
  },
};
