/**
 * PostgREST Client (CommonJS)
 *
 * Drop-in replacement for @supabase/supabase-js createClient.
 * Returns an object with .from(table) that supports the same chainable API:
 ...
 *
 * URL: process.env.NEXT_PUBLIC_API_URL || process.env.SUPABASE_URL
 * Key: process.env.API_SECRET_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.LEADFLOW_API_KEY
 */
 ...
 *
 * @param {string} url - PostgREST base URL (or Supabase URL - /rest/v1 is NOT appended)
