...
const supabase = (process.env.NEXT_PUBLIC_API_URL || process.env.SUPABASE_URL)
  ? createClient(
...
async function handleCheckoutCompleted(session) {
  ...
  // Persist subscription record if this was a subscription checkout
  if (supabase && stripe && userId && subscriptionId) {
    try {
