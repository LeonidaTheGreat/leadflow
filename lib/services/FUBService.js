...
const AiSmsService = require('./AiSmsService');
const _defaultAiSmsService = new AiSmsService();
...
class FUBService {
  constructor(options = {}) {
    ...
    this.aiSmsService = options.aiSmsService || _defaultAiSmsService;
  ...
  async generateAiSmsResponse(lead, options = {}) {
    return this.aiSmsService.generateAiSmsResponse(lead, options);
  }
