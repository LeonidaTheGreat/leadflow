...
class FUBService {
  constructor(options = {}) {
    ...
    this.createLeadSequence = options.createLeadSequence || sequenceService.createLeadSequence.bind(sequenceService);
    this.findLeadByFubId = options.findLeadByFubId || sequenceService.findLeadByFubId.bind(sequenceService);
