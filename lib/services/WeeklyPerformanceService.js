  ...
  async getAgentWeeklyStats(agentId, weekStarting, weekEnding) {
    ...
    try {
      ...
      try {
        ...
        console.warn('[Weekly Report] Error counting leads:', error.message);
      }
      ...
      try {
        ...
        console.warn('[Weekly Report] Error calculating response time:', error.message);
      }
      ...
      try {
        ...
        console.warn('[Weekly Report] Error counting bookings:', error.message);
      }
