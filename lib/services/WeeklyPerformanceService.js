    ...
    return {
      async sendEmail(payload) {
        ...
        const response = await withRetry(
          ...
          { operationName: 'WeeklyPerformanceService.sendEmail' }
        );
  ...
  generateEmailHtml(agent, stats, weekRange) {
    ...
    if (isStarter || isTrial) {
      ...
      const ctaUrl = isStarter
        ? 'https://landyourleads.com/upgrade?plan=pro&utm_source=weekly_report&utm_medium=email&utm_campaign=starter_upgrade'
        : 'https://landyourleads.com/upgrade?plan=pro&discount=PILOT50&utm_source=weekly_report&utm_medium=email&utm_campaign=pilot_upgrade';
          ...
          <tr>
            <td style="padding: 30px 40px 40px 40px; text-align: center; border-top: 1px solid #eee; margin-top: 20px;">
              ...
              <p style="margin: 0; font-size: 12px; color: #bbb;">
                <a href="https://landyourleads.com/dashboard" style="color: #667eea; text-decoration: none;">View Dashboard</a> •
                <a href="https://landyourleads.com/settings/notifications" style="color: #667eea; text-decoration: none;">Email Preferences</a>
              </p>
            </td>
          </tr>
        </table>
    ...
    try {
      ...
      for (const agent of agents) {
        ...
        try {
          ...
          agentResult.error = 'Email send failed';
