...
// Bound export so destructuring callers retain correct `this` context
module.exports.processWebhookEvent = billingService.processWebhookEvent.bind(billingService);
