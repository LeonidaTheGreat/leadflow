...
class CalcomClient {
    constructor(options = {}) {
        ...
        this.defaultUsername = options.defaultUsername || process.env.CAL_USERNAME || null;
    ...
    generateBookingUrl(eventSlug, username) {
        const calUsername = username || this.defaultUsername || process.env.CAL_USERNAME;
...
module.exports.defaultCalcomClient = defaultCalcomClient;
