...
const log = logger.child('CalcomWebhookManagement');
...
async function registerWebhook(config) {
    ...
    const webhookId = `wh_${this.generateId()}`;
...
async function deleteWebhook(webhookId) {
    ...
    try {
        ...
        log.error('Error deleting webhook', error, { webhookId });
        throw error;
    }
}
...
async function updateWebhook(webhookId, updates) {
    ...
    try {
        ...
        log.error('Error updating webhook', error, { webhookId });
        throw error;
    }
}
...
async function getWebhook(webhookId) {
    ...
    try {
        ...
        log.error('Error getting webhook', error, { webhookId });
...
async function logWebhookDelivery(logData) {
    ...
    if (!db) {
        log.info('Webhook delivery logged (mock)', { eventType: logData.eventType, status: logData.status });
        return;
    }
    ...
    try {
        ...
        log.error('Error logging webhook delivery', error);
...
async function getWebhookDeliveryLogs(filters = {}) {
    ...
    try {
        ...
        log.error('Error getting webhook logs', error);
        // Return mock data on error (for test environments)
        if (process.env.NODE_ENV !== 'production') {
            return getMockDeliveryLogs();
        }
...
async function getWebhookStats(webhookId, dateRange = {}) {
    ...
    try {
        ...
        log.error('Error getting webhook stats', error, { webhookId });
...
async function testWebhook(webhookId) {
    ...
    try {
        ...
        try {
            ...
            const signature = this.generateTestSignature(testPayload, webhook.secret);
            
            const response = await breakers.calcom.execute(() => axios.post(
        ...
        log.error('Error testing webhook', error, { webhookId });
        throw error;
    }
}
...
class CalcomWebhookManagement {
    ...
    async listWebhooks() {
        return listWebhooks.call(this);
    }

    async registerWebhook(config) {
        return registerWebhook.call(this, config);
    }

    async deleteWebhook(webhookId) {
        return deleteWebhook.call(this, webhookId);
    }

    async updateWebhook(webhookId, updates) {
        return updateWebhook.call(this, webhookId, updates);
    }

    async getWebhook(webhookId) {
        return getWebhook.call(this, webhookId);
    }

    async logWebhookDelivery(logData) {
        return logWebhookDelivery.call(this, logData);
    }

    async getWebhookDeliveryLogs(filters = {}) {
        return getWebhookDeliveryLogs.call(this, filters);
    }

    async getWebhookStats(webhookId, dateRange = {}) {
        return getWebhookStats.call(this, webhookId, dateRange);
    }

    async testWebhook(webhookId) {
        return testWebhook.call(this, webhookId);
    }
...
const defaultWebhookManagement = new CalcomWebhookManagement();

module.exports = CalcomWebhookManagement;
module.exports.defaultWebhookManagement = defaultWebhookManagement;
module.exports.listWebhooks = (...args) => defaultWebhookManagement.listWebhooks(...args);
module.exports.registerWebhook = (...args) => defaultWebhookManagement.registerWebhook(...args);
module.exports.deleteWebhook = (...args) => defaultWebhookManagement.deleteWebhook(...args);
module.exports.updateWebhook = (...args) => defaultWebhookManagement.updateWebhook(...args);
module.exports.getWebhook = (...args) => defaultWebhookManagement.getWebhook(...args);
module.exports.logWebhookDelivery = (...args) => defaultWebhookManagement.logWebhookDelivery(...args);
module.exports.getWebhookDeliveryLogs = (...args) => defaultWebhookManagement.getWebhookDeliveryLogs(...args);
module.exports.getWebhookStats = (...args) => defaultWebhookManagement.getWebhookStats(...args);
module.exports.testWebhook = (...args) => defaultWebhookManagement.testWebhook(...args);
module.exports.generateWebhookSecret = (...args) => defaultWebhookManagement.generateWebhookSecret(...args);
