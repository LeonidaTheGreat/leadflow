...
> Generated: 2026-03-15T07:00:27.627Z | Source: `e2e_test_specs` + `use_cases` tables
...
```json
[
  "product_feedback insert occurs when real agent remains at same step >24h",
  "Alert payload includes agent_id/email, stuck step, duration, and metadata context",
