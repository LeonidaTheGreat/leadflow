...
Last updated: 2026-03-17T18:14:15.704Z
## Recent Heartbeats
```json
[
  {
  ...
  {
    "timestamp": "2026-03-17T18:14:15.554Z",
    "status": {
      "ready": 0,
      "inProgress": 1,
      "blocked": 0,
    ...
    "actions": [
      ...
      "Processed product review: 0 decisions, 4 UCs, 3 new action items",
      "Action items: +0 -1",
      "Dashboard updated",
      "Report prepared for topic 10788"
    ],
  ...
  {
    "timestamp": "2026-03-17T18:14:15.610Z",
    "status": {
      "ready": 0,
      "inProgress": 1,
      "blocked": 0,
    ...
    "actions": [
      "Optimizer: switched to speed mode (goal critical)",
      "Queried state: {\"ready\":0,\"inProgress\":1,\"blocked\":0,\"done\":913,\"total\":1000}",
      "Completed (via stdout): PM: Product Review — Lead Satisfaction Feedback Collection",
...
- Last status: {"ready":0,"inProgress":1,"blocked":0,"done":913,"total":1000}
